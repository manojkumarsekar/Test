SELECT     Count(1) AS RELOAD_PROCESSED_ROW_COUNT
FROM       ft_t_isrt isrt
...
AND        ( (
                      ...
                      AND        isrt.rtng_symbol_txt='A1(S)'
                      AND        isid.iss_id='ESL7418182')
           OR         (
                                 isrt.orig_data_prov_id = 'RAM'
                      AND        isrt.rtng_eff_tms = to_date('15/08/2018', 'DD/MM/YYYY')
                      AND        isrt.rtng_symbol_txt='A2(S)'
                      AND        isid.iss_id='ESL4608988')
           OR         (
                                 isrt.orig_data_prov_id = 'RAM'
                      AND        isrt.rtng_eff_tms = to_date('15/08/2018', 'DD/MM/YYYY')
                      AND        isrt.rtng_symbol_txt='A3(S)'
           ...
           OR         (
                                 isrt.orig_data_prov_id = 'MARC'
                      AND        isrt.rtng_eff_tms = to_date('15/08/2018', 'DD/MM/YYYY')
                      AND        isrt.rtng_symbol_txt='AA+'
                      AND        isid.iss_id='ESL4608988')
           OR         (
                                 isrt.orig_data_prov_id = 'MARC'
                      AND        isrt.rtng_eff_tms = to_date('15/08/2018', 'DD/MM/YYYY')
                      AND        isrt.rtng_symbol_txt='AAAIS'
                      AND        isid.iss_id='ESL2741151')
           )