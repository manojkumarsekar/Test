...
SELECT NEW_OID,SYSDATE,null,null,null,SYSDATE,'EIS:CSTM','FIID_3930',null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'EIS',null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null
FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM FT_T_FINS WHERE INST_NME= 'FIID_3930' );
...
SELECT NEW_OID,FINS.INST_MNEM,'BRSTRDCNTCDE','FIID_3930',SYSDATE,null,SYSDATE,'EIS:CSTM',null,null,'EIS',null,null,null,null,null,null,null,'N',null
FROM FT_T_FINS FINS WHERE INST_NME= 'FIID_3930' AND  NOT EXISTS (SELECT 1 FROM FT_T_FIID FIID  WHERE FINS_ID_CTXT_TYP='BRSTRDCNTCDE'  AND FINS.INST_MNEM= FIID.INST_MNEM);
...
FROM FT_T_FINS FINS WHERE INST_NME= 'FIID_3930' AND  NOT EXISTS (SELECT 1 FROM FT_T_FINR FINR  WHERE FINSRL_TYP='BROKER' AND FINS.INST_MNEM= FINR.INST_MNEM);


delete ft_t_accr where acct_id in 
(select acct_id from fT_T_acct where acct_nme='SHare3930' and end_tms is null) 
and rep_acct_id in (select acct_id from fT_T_acct where acct_nme='Test3930' and end_tms is null);
UPDATE ft_t_acid set end_tms =sysdate-1 where acct_id in (select acct_id from fT_T_acid where acct_alt_id='SHare3930')and end_tms is null;
UPDATE ft_t_acid set end_tms =sysdate-1 where acct_id in (select acct_id from fT_T_acid where acct_alt_id='Test3930')and end_tms is null;
DELETE FT_t_AEAR WHERE EXAC_OID IN(SELECT EXAC_OID FROM FT_T_EXAC WHERE INST_MNEM IN(SELECT INST_MNEM FROM FT_T_FINS WHERE INST_NME='FIID_3930'));
DELETE FT_T_EXAC WHERE INST_MNEM IN(SELECT INST_MNEM FROM FT_T_FINS WHERE INST_NME='FIID_3930') AND END_TMS IS NULL;