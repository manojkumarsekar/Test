...
WHERE acct_sok = (select acct_sok from ft_t_wact where intrnl_id10 = 'T5126' and  DW_STATUS_NUM =1) and DW_STATUS_NUM =1;
...
INSERT INTO FT_T_WACR
(WACR_SOK, ACCT_SOK, REP_ACCT_SOK, RL_TYP, VERSION_START_TMSMP, VERSION_END_TMSMP, DW_STATUS_NUM,START_TMS, LAST_CHG_TMS, LAST_CHG_USR_ID)
SELECT new_oid,(select ACCT_SOK from FT_T_WACT where INTRNL_ID10 = 'T5126' AND DW_STATUS_NUM=1),(select ACCT_SOK from FT_T_WACT where INTRNL_ID1 = 'TOM5126' AND DW_STATUS_NUM=1),'BL1PRIM', to_timestamp ('21/06/19 10:45:17.000000000', 'dd/mm/rr hh24:mi:ss.ff9'),to_timestamp ('31/12/99 12:00:00.000000000', 'dd/mm/rr hh24:mi:ss.ff9'),'1', to_timestamp ('21/06/19 10:45:17.000000000', 'dd/mm/rr hh24:mi:ss.ff9'), to_timestamp ('21/06/19 10:45:17.000000000', 'dd/mm/rr hh24:mi:ss.ff9'), 'AUTOTEST'
from dual where not exists (select 1 from FT_T_WACR where RL_TYP = 'BL1PRIM' and acct_sok in (select acct_sok from FT_T_WACT where INTRNL_ID10 = 'T5126' AND DW_STATUS_NUM=1) AND DW_STATUS_NUM=1);
