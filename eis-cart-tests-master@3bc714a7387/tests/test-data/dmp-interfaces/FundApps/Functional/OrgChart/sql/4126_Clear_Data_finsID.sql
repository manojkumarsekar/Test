UPDATE ft_t_fiid  set  end_tms =(START_TMS-2),start_tms =(START_TMS-1)
...
UPDATE ft_t_fiid set end_tms = (start_tms-2),start_tms =(START_TMS-1)
where  fins_id in ('6624412','72501087-01','1','5996709') and fins_id_ctxt_typ='RCRLBUCOM' and
 last_chg_usr_id ='EIS_RCRLBU_ORG_CHART';
