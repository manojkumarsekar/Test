SELECT COUNT (1) AS ETID_PROCESSED_ROW_COUNT
FROM FT_T_ETID WHERE EXEC_TRN_ID_CTXT_TYP IN( 'BRSTRNID', 'PLACEMENT_NUM' )
AND EXEC_TRN_ID IN ('5050263','3204-2776_valid_trade') AND EXEC_TRD_ID IN ( SELECT EXEC_TRD_ID
                                                                                                                                                                   FROM FT_T_EXTR
