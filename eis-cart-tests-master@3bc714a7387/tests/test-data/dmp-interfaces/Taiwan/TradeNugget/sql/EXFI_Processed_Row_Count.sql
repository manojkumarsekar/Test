SELECT COUNT (1) AS EXFI_PROCESSED_ROW_COUNT
FROM FT_T_EXFI
WHERE CALL_OPT_YIELD_CPCT = '1.2' AND   WORST_YIELD_CPCT = '1.1' AND   DIRTY_CPRC = '1.3' AND   EXEC_TRD_ID IN ( SELECT EXEC_TRD_ID
                                                                                                         FROM FT_T_EXTR
