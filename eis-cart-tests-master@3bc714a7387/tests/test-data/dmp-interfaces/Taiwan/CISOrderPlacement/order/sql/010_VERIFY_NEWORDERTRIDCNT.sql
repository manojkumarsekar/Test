 SELECT COUNT(*) AS NEWORDERTRIDCNT FROM FT_T_TRID
    WHERE MAIN_ENTITY_ID = (SELECT AUOR_OID FROM FT_T_AUOR WHERE PREF_ORDER_ID = '225219' AND PREF_ORDER_ID_CTXT_TYP = 'BRS_ORDER' AND ACCT_ID IS NOT NULL )
    ...
    AND TRN_MSG_STAT_DESC LIKE '225219_${PORTFOLIOCRTSID}_${BCUSIP}_%_ACTIVE_%'
    AND JOB_ID IN
      (SELECT JOB_ID FROM
