 SELECT COUNT(*) AS REVORDERTRIDCOUNT FROM FT_T_TRID
    WHERE MAIN_ENTITY_ID = (SELECT AUOR_OID FROM FT_T_AUOR WHERE PREF_ORDER_ID = '225212' AND PREF_ORDER_ID_CTXT_TYP = 'BRS_ORDER' AND ACCT_ID IS NOT NULL  AND LAST_CHG_USR_ID = 'EIS_BRS_DMP_ORDERS')
    ...
    AND TRN_MSG_STAT_DESC LIKE '225212_${PORTFOLIOCRTSID}_${BCUSIP}_%_ACTIVE_%'
    AND JOB_ID IN
      (SELECT JOB_ID FROM
