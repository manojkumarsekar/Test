...
WHERE  ACCT_ID IN (SELECT ACCT_ID from FT_T_ACID WHERE ACCT_ALT_ID='TT107' AND END_TMS IS NULL)
...
AND ACCT_ALT_ID = 'TT107' AND END_TMS IS NULL AND NOT EXISTS (SELECT 1 FROM FT_T_ACST WHERE A.ACCT_ID = ACCT_ID AND STAT_DEF_ID = 'ESUNPLTF'
