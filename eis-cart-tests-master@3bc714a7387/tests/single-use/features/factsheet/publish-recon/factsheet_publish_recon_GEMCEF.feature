...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_gemcef
Feature: Factsheet (CSV files) Reconciliations for GEMCEF
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/GEMCEF/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/GEMCEF/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code 500320
      | fund_code | file                |
      | 500320    | TOP10_HOLDINGS.csv  |
      | 500320    | COUNTRY.csv         |
      | 500320    | COUNTRY_DETAILS.csv |
      | 500320    | SECTOR.csv          |
      | 500320    | SECTOR_DETAILS.csv  |
