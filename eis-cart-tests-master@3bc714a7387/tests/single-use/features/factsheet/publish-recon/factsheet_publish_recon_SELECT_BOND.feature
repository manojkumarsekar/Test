...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_selbond
Feature: Factsheet (CSV files) Reconciliations for PRU_Select_Bond
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/PRU_Select_Bond/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/PRU_Select_Bond/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code SG3830
      | fund_code | file                 |
      | SG3830    | TOP10_HOLDINGS.csv   |
      | SG3830    | COUNTRY.csv          |
      | SG3830    | COUNTRY_DETAILS.csv  |
      | SG3830    | MATURITY.csv         |
      | SG3830    | MATURITY_DETAILS.csv |
      | SG3830    | RATINGS.csv          |
      | SG3830    | RATINGS_DETAILS.csv  |
      | SG3830    | SECTOR.csv           |
      | SG3830    | SECTOR_DETAILS.csv   |
