...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_gmag
Feature: Factsheet (CSV files) Reconciliations for GMAG
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/GMAG/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/GMAG/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code 500620
      | fund_code | file                         |
      | 500620    | TOP10_HOLDINGS.csv           |
      | 500620    | FUND_ALLOCATION.csv          |
      | 500620    | FUND_ALLOCATION_DETAILS.csv  |