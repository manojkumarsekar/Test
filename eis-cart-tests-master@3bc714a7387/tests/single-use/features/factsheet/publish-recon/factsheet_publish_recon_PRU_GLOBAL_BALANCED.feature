...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_glbbal
Feature: Factsheet (CSV files) Reconciliations for PRU_Global_Balanced
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/PRU_Global_Balanced/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/PRU_Global_Balanced/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code SG2190
      | fund_code | file                |
      | SG2190    | TOP10_HOLDINGS.csv  |
      | SG2190    | COUNTRY.csv         |
      | SG2190    | COUNTRY_DETAILS.csv |
      | SG2190    | FUND_ALLOCATION.csv |
      | SG2190    | SECTOR.csv          |
      | SG2190    | SECTOR_DETAILS.csv  |
