...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_asiabond
Feature: Factsheet (CSV files) Reconciliations
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code CASH_FUND
      | fund_code | file                       |
      | CASH_FUND | REM_PERIOD_TO_MATURITY.csv |
      | CASH_FUND | TOP10_HOLDINGS.csv         |