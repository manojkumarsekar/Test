...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_asiabal
Feature: Factsheet (CSV files) Reconciliations for PRU_Asian_Balanced
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/PRU_Asian_Balanced/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/PRU_Asian_Balanced/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code SG4455
      | fund_code | file                 |
      | SG4455    | TOP10_HOLDINGS.csv   |
      | SG4455    | COUNTRY.csv          |
      | SG4455    | COUNTRY_DETAILS.csv  |
      | SG4455    | FUND_ALLOCATION.csv  |
      | SG4455    | MATURITY.csv         |
      | SG4455    | MATURITY_DETAILS.csv |
      | SG4455    | RATINGS.csv          |
      | SG4455    | RATINGS_DETAILS.csv  |
      | SG4455    | SECTOR.csv           |
      | SG4455    | SECTOR_DETAILS.csv   |
