...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_cashfund
Feature: Factsheet (CSV files) Reconciliations for CASH_FUND
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/CASH_FUND/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/CASH_FUND/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code CASH_FUND
      | fund_code | file                       |
      | CASHFUND | REM_PERIOD_TO_MATURITY.csv |
      | CASHFUND | TOP10_HOLDINGS.csv         |