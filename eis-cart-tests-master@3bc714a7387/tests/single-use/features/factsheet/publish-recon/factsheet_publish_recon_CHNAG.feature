...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_chnag
Feature: Factsheet (CSV files) Reconciliations for CHNAG
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/CHNAG/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/CHNAG/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code CHNAG
      | fund_code | file               |
      | 500730    | SECTOR.csv         |
      | 500730    | SECTOR_DETAILS.csv |
      | 500730    | TOP10_HOLDINGS.csv |