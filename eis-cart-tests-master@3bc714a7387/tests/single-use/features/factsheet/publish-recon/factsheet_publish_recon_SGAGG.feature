...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_sgagg
Feature: Factsheet (CSV files) Reconciliations for SGAGG
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/SGAGG/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/SGAGG/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code 500710
      | fund_code | file                |
      | 500710    | SECTOR.csv          |
      | 500710    | SECTOR_DETAILS.csv  |
      | 500710    | TOP10_HOLDINGS.csv  |
      | 500710    | COUNTRY.csv         |
      | 500710    | COUNTRY_DETAILS.csv |
