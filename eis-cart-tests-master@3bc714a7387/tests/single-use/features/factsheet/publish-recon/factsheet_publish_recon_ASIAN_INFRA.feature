...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_asianinfra
Feature: Factsheet (CSV files) Reconciliations for PRU_Asian_Infra
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/PRU_Asian_Infra/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/PRU_Asian_Infra/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code SG2138
      | fund_code | file                |
      | SG2138    | TOP10_HOLDINGS.csv  |
      | SG2138    | COUNTRY.csv         |
      | SG2138    | COUNTRY_DETAILS.csv |
      | SG2138    | SECTOR.csv          |
      | SG2138    | SECTOR_DETAILS.csv  |
