...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_others
Feature: Factsheet (CSV files) Reconciliations for OTHERS
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/OTHERS/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/OTHERS/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code 500150
      | fund_code | file                |
      | 500150    | TOP10_HOLDINGS.csv  |
      | 500150    | COUNTRY.csv         |
      | 500150    | COUNTRY_DETAILS.csv |
      | 500150    | SECTOR.csv          |
      | 500150    | SECTOR_DETAILS.csv  |

    Examples: Fund Code 500410
      | fund_code | file                |
      | 500410    | TOP10_HOLDINGS.csv  |
      | 500410    | COUNTRY.csv         |
      | 500410    | COUNTRY_DETAILS.csv |
      | 500410    | SECTOR.csv          |
      | 500410    | SECTOR_DETAILS.csv  |

    Examples: Fund Code 500580
      | fund_code | file                |
      | 500580    | TOP10_HOLDINGS.csv  |
      | 500580    | COUNTRY.csv         |
      | 500580    | COUNTRY_DETAILS.csv |
      | 500580    | SECTOR.csv          |
      | 500580    | SECTOR_DETAILS.csv  |
