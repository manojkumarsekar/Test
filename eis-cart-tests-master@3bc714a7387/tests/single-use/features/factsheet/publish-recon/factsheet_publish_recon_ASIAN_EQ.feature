...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_asianeq
Feature: Factsheet (CSV files) Reconciliations for PRU_ASEAN_Equity
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/PRU_ASEAN_Equity/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/PRU_ASEAN_Equity/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code SG3833
      | fund_code | file                |
      | SG3833    | TOP10_HOLDINGS.csv  |
      | SG3833    | COUNTRY.csv         |
      | SG3833    | COUNTRY_DETAILS.csv |
      | SG3833    | SECTOR.csv          |
      | SG3833    | SECTOR_DETAILS.csv  |
