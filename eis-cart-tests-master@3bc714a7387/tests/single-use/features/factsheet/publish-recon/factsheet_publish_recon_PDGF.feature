...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_pdgf
Feature: Factsheet (CSV files) Reconciliations for PDGF
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/PDGF/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/PDGF/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code SG9121
      | fund_code | file                |
      | SG9121    | TOP10_HOLDINGS.csv  |
      | SG9121    | COUNTRY.csv         |
      | SG9121    | COUNTRY_DETAILS.csv |
      | SG9121    | SECTOR.csv          |
      | SG9121    | SECTOR_DETAILS.csv  |
