...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_genf
Feature: Factsheet (CSV files) Reconciliations for GENF
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/GENF/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/GENF/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code 500421
      | fund_code | file               |
      | 500421    | TOP10_HOLDINGS.csv |