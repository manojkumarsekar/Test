...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_glbtech
Feature: Factsheet (CSV files) Reconciliations for PRU_Global_Tech
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/PRU_Global_Tech/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/PRU_Global_Tech/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code SG3827
      | fund_code | file               |
      | SG3827    | TOP10_HOLDINGS.csv |
      | SG3827    | COUNTRY.csv        |
      | SG3827    | SECTOR.csv         |
