...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_gmnf
Feature: Factsheet (CSV files) Reconciliations for GMNF
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/GMNF/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/GMNF/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code 500460
      | fund_code | file                 |
      | 500460    | TOP10_HOLDINGS.csv   |
      | 500460    | FUND_ALLOCATION.csv  |