...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_jpnfumtlval
Feature: Factsheet (CSV files) Reconciliations for Japan_Fundamental_Value
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/Japan_Fundamental_Value/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/Japan_Fundamental_Value/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code 500490
      | fund_code | file                |
      | 500490    | TOP10_HOLDINGS.csv  |
      | 500490    | SECTOR.csv   |
      | 500490    | SECTOR_DETAILS.csv   |
