...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_eurinv_gradebond
Feature: Factsheet (CSV files) Reconciliations for EUR_INV_GRADE_BONDS
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/EUR_INV_GRADE_BONDS/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/EUR_INV_GRADE_BONDS/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code 500190
      | fund_code | file               |
      | 500190    | TOP10_HOLDINGS.csv |
      | 500190    | COUNTRY.csv        |
      | 500190    | MATURITY.csv       |
      | 500190    | RATINGS.csv        |
      | 500190    | RATINGS_BD.csv     |
      | 500190    | SECTOR.csv         |
