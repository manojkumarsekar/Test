...
@ignore_hooks @factsheet_publish_recon  @factsheet_publish_recon_paneuro
Feature: Factsheet (CSV files) Reconciliations for PRU_Pan_European
  ...
  Scenario: Set up Test data paths and prerequisites
    ...
    Given I assign "tests/features/factsheet/publish-recon/test-data/PRU_Pan_European/AZURE" to variable "SRC1_TESTDATA_PATH"
    And I assign "tests/features/factsheet/publish-recon/test-data/PRU_Pan_European/EAGLE" to variable "SRC2_TESTDATA_PATH"
  ...
  Scenario Outline: Reconciliations of Factsheet : Fund Code "<fund_code>" for "<file>"
    ...
    Examples: Fund Code SG3828
      | fund_code | file               |
      | SG3828    | TOP10_HOLDINGS.csv |
      | SG3828    | COUNTRY.csv        |
      | SG3828    | SECTOR.csv         |
