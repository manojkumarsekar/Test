...
@dmp_wfoe @dmp_wfoe_transactions @dmp_wfoe_transactions_verify_hf_manfldexp @tom_4205
Feature: 005 | China-WFOE | Transactions | Verify Header and Footer in case First and Last record in Input file fails for Mandatory Field Exception

  Scenario: Verify Header and Footer in case First and Last record in Input file fails for Mandatory Field Exception

    Given I assign "005_esi_sc_transactions_verify_hf_manfldexcp.csv" to variable "INPUT_FILENAME"
