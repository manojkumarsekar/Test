...
@dmp_wfoe @dmp_wfoe_transactions @dmp_wfoe_transactions_verify_hf_sectypexp @tom_4205
Feature: 004 | China-WFOE | Transactions | Verify Header and Footer in case First and Last record in Input file fails for Sec Type Exception

  Scenario: Verify Header and Footer in case First and Last record in Input file fails for Sec Type Exception

    Given I assign "004_esi_sc_transactions_verify_hf_sectypexcp.csv" to variable "INPUT_FILENAME"
