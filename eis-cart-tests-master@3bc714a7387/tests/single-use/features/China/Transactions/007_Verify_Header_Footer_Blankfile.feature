...
@dmp_wfoe @dmp_wfoe_transactions @dmp_wfoe_transactions_verify_hf_0rec @tom_4205 @tom_4339
Feature: 007 | China-WFOE | Transactions | Verify blank file is not generated in case no records in file to process

  Scenario: Verify blank file is not generated in case no records in file to process

    Given I assign "007_esi_sc_transactions_verify_hf_0rec.csv" to variable "INPUT_FILENAME"
    ...
    And I rename file "${PUBLISHING_DIR}/${OUTPUT_FILENAME}_${VAR_SYSDATE}.csv" as "${PUBLISHING_DIR}/007_${OUTPUT_FILENAME}_${VAR_SYSDATE}.csv" in the named host "dmp.ssh.inbound"
