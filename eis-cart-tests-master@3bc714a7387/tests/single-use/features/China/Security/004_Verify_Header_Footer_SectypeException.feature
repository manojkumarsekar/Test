...
@dmp_wfoe @dmp_wfoe_security @dmp_wfoe_security_verify_hf_sectypexp @tom_4195
Feature: 004 | China-WFOE | Security | Verify Header and Footer in case First and Last record in Input file fails for Sec Type Exception

  Scenario: Verify Header and Footer in case First and Last record in Input file fails for Sec Type Exception

    Given I assign "004_esi_sc_security_verify_hf_sectypexcp.csv" to variable "INPUT_FILENAME"
