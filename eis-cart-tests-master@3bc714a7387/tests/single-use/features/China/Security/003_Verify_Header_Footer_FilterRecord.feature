...
@dmp_wfoe @dmp_wfoe_security @dmp_wfoe_security_verify_hf_filter @tom_4195
Feature: 003 | China-WFOE | Security | Verify Header and Footer in case First and Last record in Input file is Filtered Record

  Scenario: Verify Header and Footer in case First and Last record in Input file is Filtered Record

    Given I assign "003_esi_sc_security_verify_hf_filter.csv" to variable "INPUT_FILENAME"
