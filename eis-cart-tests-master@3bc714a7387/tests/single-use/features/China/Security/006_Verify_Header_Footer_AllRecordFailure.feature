...
@dmp_wfoe @dmp_wfoe_security @dmp_wfoe_security_verify_hf_allrecfail @tom_4195
Feature: 006 | China-WFOE | Security | Verify blank file is not generated in case all records in input file fails

  Scenario: Verify blank file is not generated in case all records in input file is

    Given I assign "006_esi_sc_security_verify_hf_allrecfail.csv" to variable "INPUT_FILENAME"
    And I assign "WFOEEISLINSTMT" to variable "OUTPUT_FILENAME"
    And I assign "006_007_WFOEEISLINSTMT_TEMPLATE.csv" to variable "MASTER_FILENAME"
