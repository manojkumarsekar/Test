...
@dmp_wfoe @dmp_wfoe_security @dmp_wfoe_security_verify_hf_0rec @tom_4195
Feature: 007 | China-WFOE | Security | Verify blank file is not generated in case no records in file to process

  Scenario: Verify blank file is not generated in case no records in file to process

    Given I assign "007_esi_sc_security_verify_hf_0rec.csv" to variable "INPUT_FILENAME"
