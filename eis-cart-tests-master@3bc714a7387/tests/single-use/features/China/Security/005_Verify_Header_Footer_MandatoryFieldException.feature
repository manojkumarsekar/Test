...
@dmp_wfoe @dmp_wfoe_security @dmp_wfoe_security_verify_hf_manfldexp @tom_4195
Feature: 005 | China-WFOE | Security | Verify Header and Footer in case First and Last record in Input file fails for Mandatory Field Exception

  Scenario: Verify Header and Footer in case First and Last record in Input file fails for Mandatory Field Exception

    Given I assign "005_esi_sc_security_verify_hf_manfldexcp.csv" to variable "INPUT_FILENAME"
    And I assign "WFOEEISLINSTMT" to variable "OUTPUT_FILENAME"
    And I assign "003_004_005_WFOEEISLINSTMT_TEMPLATE.csv" to variable "MASTER_FILENAME"
