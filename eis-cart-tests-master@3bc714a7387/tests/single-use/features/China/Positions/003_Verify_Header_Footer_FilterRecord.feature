...
@dmp_wfoe @dmp_wfoe_positions @dmp_wfoe_positions_verify_hf_filter @tom_4206
Feature: 003 | China-WFOE | Positions | Verify Header and Footer in case First and Last record in Input file is Filtered Record

  Scenario: Verify Header and Footer in case First and Last record in Input file is Filtered Record

    Given I assign "003_esi_sc_positions_verify_hf_filter.csv" to variable "INPUT_FILENAME"
