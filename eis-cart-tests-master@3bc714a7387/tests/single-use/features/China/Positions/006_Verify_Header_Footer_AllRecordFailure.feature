...
@dmp_wfoe @dmp_wfoe_positions @dmp_wfoe_positions_verify_hf_allrecfail @tom_4206
Feature: 006 | China-WFOE | Positions | Verify blank file is not generated in case all records in input file fails

  Scenario: Verify blank file is not generated in case all records in input file fails

    Given I assign "006_esi_sc_positions_verify_hf_allrecfail.csv" to variable "INPUT_FILENAME"
