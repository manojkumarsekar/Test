Feature: TC_BOND_03 - Trade Lifecycle

  @tlc9000 @tlc9000_bonds
  Scenario Outline: TC_BOND_03: BUY_BYMLCD5_<TxnStatus>

    Given I place "Bond" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | BYMLCD5    | Buy     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+3        | 1980000 | 100.75   | SCB-ES   | GEN        |
      | Amend     | T         | T+3        | 1980000 | 101.75   | SCB-ES   | GEN        |
      | Cancel    | T         | T+3        | 1980000 | 101.75   | SCB-ES   | GEN        |
