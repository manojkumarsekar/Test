Feature: TC_BOND_010 - Trade Lifecycle

  @tlc9000 @tlc9000_bonds
  Scenario Outline: TC_BOND_010: BUY_BYVK006_<TxnStatus>

    Given I place "Bond" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | BYVK006    | Buy     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+3        | 3000000 | 98.95    | HSBC-ES  | GEN        |
      | Cancel    | T         | T+3        | 3000000 | 98.95    | HSBC-ES  | GEN        |
