Feature: TC_BOND_013 - Trade Lifecycle

  @tlc9000 @tlc9000_bonds
  Scenario Outline: TC_BOND_013: SELL_BF165M8_<TxnStatus>

    Given I place "Bond" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | BF165M8    | SELL    |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 43000000 | 40.853   | UOB-ES   | GEN        |
      | Amend     | T         | T+3        | 43000000 | 40.853   | GOLD-ES  | GEN        |
