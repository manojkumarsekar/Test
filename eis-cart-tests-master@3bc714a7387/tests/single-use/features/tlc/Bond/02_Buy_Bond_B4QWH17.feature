Feature: TC_BOND_02 - Trade Lifecycle

  @tlc9000 @tlc9000_bonds
  Scenario Outline: TC_BOND_02: BUY_B4QWH17_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+3        | 3100000000 | 96.5     | SCLO-ES  | GEN        |
      | Cancel    | T         | T+3        | 3100000000 | 96.5     | SCLO-ES  | GEN        |
