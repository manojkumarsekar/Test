Feature: TC_FXFWD_013 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxfwds
  Scenario Outline: TC_FXFWD_013: BUY_THBUSD_<TxnStatus>

    Given I place "FXFwd" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | THBUSD     | BUY     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 50000000 | 0.0317858902 | WBC-ES   | WBC-AU     |
      | Amend     | T         | T+1        | 50000000 | 0.032        | WBC-ES   | WBC-AU     |
      | Cancel    | T         | T+1        | 50000000 | 0.032        | WBC-ES   | WBC-AU     |