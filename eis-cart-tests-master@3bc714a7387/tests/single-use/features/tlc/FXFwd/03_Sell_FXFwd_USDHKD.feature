Feature: TC_FXFWD_03 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxfwds
  Scenario Outline: TC_FXFWD_03: SELL_USDHKD_<TxnStatus>

    Given I place "FXFwd" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | USDHKD     | SELL    |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 11000000 | 7.8427   | UBS-ES   | UBS-SG     |
      | Amend     | T         | T+1        | 12000000 | 7.8427   | UBS-ES   | UBS-SG     |
      | Cancel    | T         | T+1        | 12000000 | 7.8427   | UBS-ES   | UBS-SG     |
