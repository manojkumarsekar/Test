Feature: TC_FXFWD_05 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxfwds
  Scenario Outline: TC_FXFWD_05: SELL_USDTHB_<TxnStatus>

    Given I place "FXFwd" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | USDTHB     | SELL    |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 7600000 | 31.559   | SCB-ES   | SCB-TH     |
