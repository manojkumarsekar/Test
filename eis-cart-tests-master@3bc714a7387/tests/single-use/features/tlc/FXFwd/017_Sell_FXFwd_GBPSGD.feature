Feature: TC_FXFWD_017 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxfwds
  Scenario Outline: TC_FXFWD_017: SELL_GBPSGD_<TxnStatus>

    Given I place "FXFwd" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | GBPSGD     | SELL    |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 116100000 | 1.8498   | UBS-ES   | UBS-SG     |
      | Amend     | T         | T+1        | 116100000 | 1.85     | UBS-ES   | UBS-SG     |
      | Cancel    | T         | T+1        | 116100000 | 1.85     | UBS-ES   | UBS-SG     |