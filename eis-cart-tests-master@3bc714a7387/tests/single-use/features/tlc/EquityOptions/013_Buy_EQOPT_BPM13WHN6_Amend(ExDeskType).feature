Feature: TC_EQOP_013 - Trade Lifecycle

  @tlc90001 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_013: BUY_BPM13WHN6_<TxnStatus>

    Given I place "EquityOption" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | BPM13WHN6  | Buy     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 11387.01 | OCBC-ES  | ALGO       |
      | Amend     | T         | T+2        | 12000000 | 11387.01 | OCBC-ES  | OCBC-MY    |
