Feature: TC_EQOP_017 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_017: SELL_BPM13WHN6_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 11387.02 | OCBC-ES  | ALGO       |
      | Amend     | T         | T+2        | 12000000 | 11387.02 | OCBC-ES  | GEN        |
