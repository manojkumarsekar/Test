Feature: TC_EQOP_09 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_09: SELL_BPM1EW218_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 1.86     | OCBC-ES  | ALGO       |
      | Cancel    | T         | T+2        | 12000000 | 1.86     | OCBC-ES  | ALGO       |