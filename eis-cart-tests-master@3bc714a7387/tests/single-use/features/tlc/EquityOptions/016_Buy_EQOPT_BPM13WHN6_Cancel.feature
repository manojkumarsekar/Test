Feature: TC_EQOP_016 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_016: BUY_BPM13WHN6_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 11380.86 | OCBC-ES  | ALGO       |
      | Cancel    | T         | T+2        | 12000000 | 11380.86 | OCBC-ES  | ALGO       |
