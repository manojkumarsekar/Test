Feature: TC_EQOP_04 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_04: BUY_BPM1EW218_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 100.86   | OCBC-ES  | ALGO       |
      | Amend     | T         | T+2        | 20000000 | 100.86   | OCBC-ES  | ALGO       |
