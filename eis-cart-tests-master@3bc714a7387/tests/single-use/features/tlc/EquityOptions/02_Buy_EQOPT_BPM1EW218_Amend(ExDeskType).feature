Feature: TC_EQOP_02 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_02: BUY_BPM1EW218_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 11000000 | 1.86     | OCBC-ES  | ALGO       |
      | Amend     | T         | T+2        | 11000000 | 1.86     | OCBC-ES  | OCBC-MY    |
