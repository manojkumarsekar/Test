Feature: TC_EQOP_08 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_08: SELL_BPM1EW218_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 2.01     | OCBC-ES  | ALGO       |
      | Amend     | T         | T+2        | 10000000 | 2.01     | OCBC-ES  | ALGO       |
