Feature: TC_EQOP_015 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_015: BUY_BPM13WHN6_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 11377.86 | OCBC-ES  | ALGO       |
      | Amend     | T         | T+2        | 20000000 | 11377.86 | OCBC-ES  | ALGO       |
