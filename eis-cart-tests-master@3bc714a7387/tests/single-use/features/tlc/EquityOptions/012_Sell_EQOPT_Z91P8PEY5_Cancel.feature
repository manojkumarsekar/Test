Feature: TC_EQOP_012 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_012: SELL_Z91P8PEY5_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 4462.86  | OCBC-ES  | ALGO       |
      | Cancel    | T         | T+2        | 12000000 | 4462.86  | OCBC-ES  | ALGO       |
