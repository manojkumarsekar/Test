Feature: TC_EQOP_014 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_014: BUY_BPM13WHN6_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 11386.86 | OCBC-ES  | ALGO       |
      | Amend     | T         | T+4        | 12000000 | 11386.86 | OCBC-ES  | ALGO       |
