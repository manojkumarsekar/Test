Feature: TC_EQOP_018 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_018: SELL_BPM13WHN6_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 12000000 | 11390.86 | OCBC-ES  | ALGO       |
      | Amend     | T         | T+4        | 12000000 | 11390.86 | OCBC-ES  | ALGO       |
