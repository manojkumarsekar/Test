Feature: TC_EQOP_01 - Trade Lifecycle

  @tlc9000 @tlc9000_eq_options
  Scenario Outline: TC_EQOP_01: BUY_BPM1EW218_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+2        | 10000000 | 1.86     | OCBC-ES  | ALGO       |
      | Amend     | T         | T+2        | 10000000 | 1.86     | CITI-ES  | GEN        |
