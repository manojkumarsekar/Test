Feature: TC_FUT_04 - Trade Lifecycle

  @tlc9000  @tlc9000_futures
  Scenario Outline: TC_FUT_04: SELL_RTSH92016_<TxnStatus>

    Given I place "Futures" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | RTSH92016  | SELL    |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 200    | 111.945  | NATW-ES  | GEN        | JPMFUT-ES |
      | Amend     | T         | T+1        | 200    | 111.945  | JPM-ES   | FUT        | JPMFUT-ES |
      | Cancel    | T         | T+1        | 200    | 111.945  | JPM-ES   | FUT        | JPMFUT-ES |