Feature: TC_FUT_06 - Trade Lifecycle

  @tlc9000  @tlc9000_futures
  Scenario Outline: TC_FUT_06: SELL_KMZ920191_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 210    | 101.478  | MACQ-ES  | FUT        | NATFUT-ES |
      | Amend     | T         | T+1        | 210    | 101.478  | MACQ-ES  | FUT        | JPMFUT-ES |
