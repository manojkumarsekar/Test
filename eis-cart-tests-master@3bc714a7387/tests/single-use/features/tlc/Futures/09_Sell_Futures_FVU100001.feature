Feature: TC_FUT_09 - Trade Lifecycle

  @tlc9000 @tlc9000_futures
  Scenario Outline: TC_FUT_09: SELL_FVU100001_<TxnStatus>

    Given I place "Futures" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | FVU100001  | SELL    |
    ...
    Examples: Trade Params
      ...
      | Amend     | T         | T+3        | 100    | 100.86   | GOLD-ES  | FUT        | CITIFUT-ES |
