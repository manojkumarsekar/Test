Feature: TC_FUT_07 - Trade Lifecycle

  @tlc9000  @tlc9000_futures
  Scenario Outline: TC_FUT_07: BUY_WNH920196_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 220    | 101.478  | MACQ-ES  | FUT        | NATFUT-ES |
      | Amend     | T         | T+1        | 220    | 101.478  | CITI-ES  | GEN        | NATFUT-ES |
