Feature: TC_FUT_02 - Trade Lifecycle

  @tlc9000  @tlc9000_futures
  Scenario Outline: TC_FUT_02: SELL_KMZ920191_<TxnStatus>

    Given I place "Futures" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | KMZ920191  | SELL    |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 175    | 101.478  | CGML-ES  | FUT        | JPMFUT-ES |
      | Cancel    | T         | T+1        | 175    | 101.478  | CGML-ES  | FUT        | JPMFUT-ES |
