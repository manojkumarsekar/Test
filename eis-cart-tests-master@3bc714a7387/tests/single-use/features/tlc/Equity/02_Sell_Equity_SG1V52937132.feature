Feature: TC_EQUITY_02 - Trade Lifecycle

  @tlc9000 @tlc9000_equities
  Scenario Outline: TC_EQUITY_02: SELL_SG1V52937132_<TxnStatus>

    Given I place "Equity" order for:
      | Portfolio | FundId | Instrument   | TxnType |
      | TSTALCHEF | 4033   | SG1V52937132 | Sell    |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+3        | 119800 | 3.4806   | CLSA-ES  | CASH       |
      | Amend     | T         | T+3        | 219800 | 3.4806   | CLSA-ES  | CASH       |
      | Cancel    | T         | T+3        | 219800 | 3.4806   | CLSA-ES  | CASH       |
