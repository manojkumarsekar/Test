Feature: TC_EQUITY_06 - Trade Lifecycle

  @tlc9000 @tlc9000_equities
  Scenario Outline: TC_EQUITY_06: SELL_BMG6542T1505_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+3        | 82100  | 0.0893014 | INST-ES  | PROGRAM    |
      | Amend     | T         | T+3        | 82100  | 0.0893014 | INST-ES  | PROGRAM    |
      | Cancel    | T         | T+3        | 82100  | 0.0893014 | INST-ES  | PROGRAM    |
