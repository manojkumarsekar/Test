Feature: TC_EQUITY_08 - Trade Lifecycle

  @tlc9000 @tlc9000_equities
  Scenario Outline: TC_EQUITY_08: BUY_INE002A01018_<TxnStatus>

    Given I place "Equity" order for:
      | Portfolio | FundId | Instrument   | TxnType |
      | TSTALCHEF | 4033   | INE002A01018 | Buy     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+3        | 40488  | 999.39900 | JPM-ES   | CASH       |
      | Amend     | T         | T+3        | 40488  | 999.39900 | JPM-ES   | CASH       |
      | Cancel    | T         | T+3        | 40488  | 999.39900 | JPM-ES   | CASH       |
