Feature: TC_EQUITY_03 - Trade Lifecycle

  @tlc9000 @tlc9000_equities
  Scenario Outline: TC_EQUITY_03: BUY_BMG524181036_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+3        | 500    | 11.828   | MLIN-ES  | ALGO       |
      | Amend     | T         | T+3        | 500    | 12.828   | MLIN-ES  | ALGO       |
      | Cancel    | T         | T+3        | 500    | 12.828   | MLIN-ES  | ALGO       |
