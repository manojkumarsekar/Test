Feature: TC_EQUITY_019 - Trade Lifecycle
# NO amendement or cancel

  @tlc9000 @tlc9000_equities
  Scenario Outline: TC_EQUITY_019: BUY_PHY7072Q1032_<TxnStatus>

    Given I place "Equity" order for:
      | Portfolio | FundId | Instrument   | TxnType |
      | TSTALCHEF | 4033   | PHY7072Q1032 | Buy     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 3650   | 1426.634246575 | CLSA-ES  | PROGRAM    |
