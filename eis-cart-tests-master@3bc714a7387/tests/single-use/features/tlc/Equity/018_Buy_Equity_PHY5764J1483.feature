Feature: TC_EQUITY_018 - Trade Lifecycle
# NO amendement or cancel

  @tlc9000 @tlc9000_equities
  Scenario Outline: TC_EQUITY_018: BUY_PHY5764J1483_<TxnStatus>

    Given I place "Equity" order for:
      | Portfolio | FundId | Instrument   | TxnType |
      | TSTALCHEF | 4033   | PHY5764J1483 | Buy     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 73600  | 310.271189171 | CLSA-ES  | PROGRAM    |
