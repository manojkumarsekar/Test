Feature: TC_FXSPOT_04 - Trade Lifecycle
  ...
  Scenario Outline: TC_FXSPOT_04: BUY_AUDUSD_<TxnStatus>

    Given I place "FXSpot" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | AUDUSD     | BUY     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 10.63  | 0.757290686736 | CONV     | GEN        |
      | Amend     | T         | T+1        | 11.63  | 0.75729069     | CONV     | GEN        |
      | Cancel    | T         | T+1        | 11.63  | 0.75729069     | CONV     | GEN        |