Feature: TC_FXSPOT_08 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxspots
  Scenario Outline: TC_FXSPOT_08: BUY_ZARUSD_<TxnStatus>

    Given I place "FXSpot" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | ZARUSD     | BUY     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 2478.96 | 0.08067093 | CONV     | GEN        |
      | Cancel    | T         | T+1        | 2478.96 | 0.08067093 | CONV     | GEN        |