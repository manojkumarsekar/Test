Feature: TC_FXSPOT_019 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxspots
  Scenario Outline: TC_FXSPOT_019: BUY_JPYSGD_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 30000000 | 0.009148553333 | BNYM-ES  | BNYM-NYK   |
      | Amend     | T         | T+1        | 30000000 | 0.00915        | BNYM-ES  | BNYM-NYK   |
      | Cancel    | T         | T+1        | 30000000 | 0.00915        | BNYM-ES  | BNYM-NYK   |