Feature: TC_FXSPOT_012 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxspots
  Scenario Outline: TC_FXSPOT_012: SELL_SGDUSD_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 39569.09 | 0.75734710 | CONV     | GEN        |
      | Cancel    | T         | T+1        | 39569.09 | 0.75734710 | CONV     | GEN        |