Feature: TC_FXSPOT_011 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxspots
  Scenario Outline: TC_FXSPOT_011: SELL_ZARUSD_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 33305.2 | 0.080670285721 | CONV     | GEN        |
      | Amend     | T         | T+1        | 33305.2 | 0.08067029     | CONV     | GEN        |
      | Cancel    | T         | T+1        | 33305.2 | 0.08067029     | CONV     | GEN        |