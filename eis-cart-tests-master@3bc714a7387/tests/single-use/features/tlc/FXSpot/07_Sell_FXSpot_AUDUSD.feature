Feature: TC_FXSPOT_07 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxspots
  Scenario Outline: TC_FXSPOT_07: SELL_AUDUSD_<TxnStatus>
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 2392.1 | 0.757347100874 | CONV     | GEN        |
      | Amend     | T         | T+1        | 2392   | 0.757347100874 | CONV     | GEN        |
      | Cancel    | T         | T+1        | 2392   | 0.757347100874 | CONV     | GEN        |