Feature: TC_FXSPOT_014 - Trade Lifecycle

  @tlc9000 @tlc9000_fx @tlc9000_fxspots
  Scenario Outline: TC_FXSPOT_014: BUY_NZDUSD_<TxnStatus>

    Given I place "FXSpot" order for:
      | Portfolio | FundId | Instrument | TxnType |
      | TSTALCHEF | 4033   | NZDUSD     | BUY     |
    ...
    Examples: Trade Params
      ...
      | New       | T         | T+1        | 82601.74 | 0.708337984164 | CONV     | GEN        |
      | Amend     | T         | T+1        | 82601.74 | 0.70833798     | CONV     | GEN        |
      | Cancel    | T         | T+1        | 82601.74 | 0.70833798     | CONV     | GEN        |