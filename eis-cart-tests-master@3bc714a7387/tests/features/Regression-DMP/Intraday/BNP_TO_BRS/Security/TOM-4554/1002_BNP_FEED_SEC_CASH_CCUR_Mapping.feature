...
@1002_tom_4554_bnp_dmp_security
Feature: BNP to DMP Security feed - Field Mapping - Cash Currency

  Description of the feature:
  As a part of this feature, we are testing:
  1. Loading Intraday Cash Currency Security Feed
  2. Validating Cash Currency specific field mappings for Security tables as per Specifications
  ...
  Scenario: Assign Variables
    ...
    And I assign "ESIINTRADAY_SEC_CCUR_LOAD.out" to variable "INPUT_FILENAME"
  ...
  Scenario Outline: BNP Security (Cash Currency) Feed Validations for <Column>
