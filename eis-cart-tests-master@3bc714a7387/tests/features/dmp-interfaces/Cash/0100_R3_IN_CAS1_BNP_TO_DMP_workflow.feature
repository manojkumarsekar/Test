#https://collaborate.intranet.asia/pages/viewpage.action?pageId=24939361
#https://jira.intranet.asia/browse/TOM-1588
#https://jira.intranet.asia/browse/TOM-1395
...
Feature: Inbound Intraday Cash Transactions Interface Testing (R3.IN.CAS1 BNP to DMP)
  ...
  Scenario Outline: TC_1: Process BNP Intraday Cash Transactions to DMP (CAS1): Data Preparation
    ...
    Examples:
      | Template                                         | InputFile                          |
      | ESIINTRADAY_TRN_NEWCASH_NEW_Template.out         | ESIINTRADAY_TRN_NEWCASH_NEW.out    |
      | ESIINTRADAY_TRN_NEWCASH_CANC_Template.out        | ESIINTRADAY_TRN_NEWCASH_CANC.out   |
      | ESIINTRADAY_TRN_MISCCASH_Template.out            | ESIINTRADAY_TRN_MISCCASH.out       |
      | ESIINTRADAY_TRN_CASHCOLLATERAL_MMDE_Template.out | ESIINTRADAY_TRN_CASH_COLL_MMDE.out |
      | ESIINTRADAY_TRN_CASHCOLLATERAL_MMWD_Template.out | ESIINTRADAY_TRN_CASH_COLL_MMWD.out |
      | ESIINTRADAY_TRN_FFXP_NEW_Template.out            | ESIINTRADAY_TRN_FFXP_NEW.out       |
      | ESIINTRADAY_TRN_FFXS_NEW_Template.out            | ESIINTRADAY_TRN_FFXS_NEW.out       |
      | ESIINTRADAY_TRN_SFXP_NEW_Template.out            | ESIINTRADAY_TRN_SFXP_NEW.out       |
      | ESIINTRADAY_TRN_SFXS_NEW_Template.out            | ESIINTRADAY_TRN_SFXS_NEW.out       |

  Scenario: TC_2: Process BNP Intraday Cash Transactions to DMP (CAS1): Data Loading
  ...
  Scenario Outline: TC_3: Process BNP Intraday Cash Transactions to DMP (CAS1): "<InputFile>" Verifications
    ...
    Examples:
      | InputFile                          |
      | ESIINTRADAY_TRN_NEWCASH_NEW.out    |
      | ESIINTRADAY_TRN_NEWCASH_CANC.out   |
      | ESIINTRADAY_TRN_MISCCASH.out       |
      | ESIINTRADAY_TRN_CASH_COLL_MMDE.out |
      | ESIINTRADAY_TRN_CASH_COLL_MMWD.out |
      | ESIINTRADAY_TRN_FFXP_NEW.out       |
      | ESIINTRADAY_TRN_FFXS_NEW.out       |
      | ESIINTRADAY_TRN_SFXP_NEW.out       |
      | ESIINTRADAY_TRN_SFXS_NEW.out       |