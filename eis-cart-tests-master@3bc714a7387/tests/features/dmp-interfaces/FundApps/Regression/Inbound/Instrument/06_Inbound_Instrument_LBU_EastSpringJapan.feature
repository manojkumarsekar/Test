...
@fa_inbound @tom_4265 @06_inbound_rcr_esjp @dmp_fundapps_functional @fund_apps_instrument
Feature: To verify that DMP receive the inbound instrument file data from the entity EastSpring Japan
  ...
  Scenario: TC_1:Prerequisites before running actual tests
    Given I assign "ESJPEISLINSTMT20190322.csv" to variable "INPUT_FILENAME"
  ...
  Scenario: TC_2: Load Eastspring Japan Security file
  ...
  Scenario: TC_3: Data Verifications for EastSpring Japan
  To verify  the inbound instrument file load in to DMP  from the entity EastSpring Japan
    ...
    AND JOB_MSG_TYP='EIS_MT_ESJP_DMP_SECURITY' AND JOB_ID = '${JOB_ID}' AND JOB_INPUT_TXT LIKE '%${INPUT_FILENAME}'
    """

  Scenario: TC_4: Data Verifications for EastSpring Japan
  To verify the Security_id from file in to DMP
    ...
    WHERE ID_CTXT_TYP = 'ESJPCODE' and ISS_ID='${ISS_ID}'
    AND TRUNC(LAST_CHG_TMS)=TRUNC(SYSDATE)
    AND END_TMS IS NULL
    """

  Scenario: TC_5: Data Verifications for EastSpring Japan : To verify DESC_USAGE_TYP (Description) in FT_T_ISDE table.
    ...
    """
     ...
     AND INSTR_ID = (SELECT INSTR_ID FROM FT_T_ISID WHERE ID_CTXT_TYP = 'ESJPCODE' and ISS_ID='${ISS_ID}' AND END_TMS IS NULL)
    """

  Scenario: TC_6: Data Verifications for EastSpring Japan: To verify the ISIN 
  ...
  Scenario: TC_7: Data Verifications for EastSpring Japan :To verify the SEDOL
  ...
  Scenario: TC_8: Data Verifications for EastSpring Japan:To verify the CUSIP
  ...
  Scenario: TC_9: Data Verifications for ESJP:To verify the  Source BU Code (ESJP)
  ...
  Scenario: TC_10: Data Verifications for :To verify the  Voting Rights Indicator
    ...
    """
      ...
      WHERE VOTING_RIGHTS_TYP = (CASE WHEN '${VOTING_RIGHTS_TYP_VALUE}' = 'Y' THEN 'V' ELSE 'N' END)
      AND INSTR_ID=(SELECT INSTR_ID FROM FT_T_ISID WHERE ID_CTXT_TYP = 'ESJPCODE' and ISS_ID='${ISS_ID}' AND END_TMS IS NULL)
    """

  Scenario: TC_11: Data Verifications for Eastspring Japan:To verify the  Next Conversion Date
  ...
  Scenario: TC_12: Data Verifications for EastSpring Japan:To verify the U/L sec ID
    ...
    """
      ...
      INSTR_ID=(SELECT INSTR_ID FROM FT_T_ISID WHERE ID_CTXT_TYP = 'ESJPCODE' AND ISS_ID='${ISS_ID}' AND END_TMS IS NULL)
      AND ISS_PART_RL_TYP='UNDLYING' AND PART_UNITS_TYP='ALL'
    """

  Scenario: TC_13: Data Verifications for EastSpring Japan:To verify the Expiry Date,Contract Size,Currency of Denomination and Security Type/Instrument Type  and
  ...
  Scenario: TC_14: Data Verifications for EastSpring Japan:To verify the CV Terms Numerator and CV Terms Denominator
  ...
  Scenario: TC_15: Data Verifications for EastSpring Japan:To verify the Option type
  ...
  Scenario: TC_16: Data Verifications for ESJP:To verify the Security Type/Instrument Type
    ...
    """
      ...
      INDUS_CL_SET_ID = 'ESJPSECTYP' AND CL_VALUE = '${SEC_TYP}' AND END_TMS IS NULL
    """
