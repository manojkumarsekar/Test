...
Feature: TOM-4320: Positions RCRLBU LEGACY file load (Golden Source) with only ALTCRTSID
  ...
  #Prerequisites
  Scenario: TC_1: Clear data for RCRLBU Position for Data Source LEGACY for Position with only ALTCRSTID

    Given I assign "tests/test-data/dmp-interfaces/FundApps/Functional/Positions" to variable "testdata.path"
    And I assign "LEGAEISLPOSITN_20190402_ALTCRTSID.csv" to variable "INPUT_FILENAME"
