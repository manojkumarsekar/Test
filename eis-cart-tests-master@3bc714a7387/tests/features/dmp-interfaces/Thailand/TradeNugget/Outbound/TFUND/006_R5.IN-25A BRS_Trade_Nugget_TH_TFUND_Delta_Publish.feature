...
@eisdev_6416 @006_tfund_onmarket_publish @dmp_thailand_hiport @dmp_thailand
Feature: Publish only the delta trades to Hiport
  ...
  Scenario: TC1: Initialize all the variables
    ...
    And I assign "006_R5.IN-25A BRS_Trade_Nugget_TH_TFUND_Transaction_Template_01.xml" to variable "TRANSACTION_TEMPLATE_01"
    And I assign "006_R5.IN-25A BRS_Trade_Nugget_TH_TFUND_Transaction_Prerequisite_01.xml" to variable "TRANSACTION_FILE_01"

    #Transaction Files with test data
    And I assign "006_R5.IN-25A BRS_Trade_Nugget_TH_TFUND_Transaction_Template_02.xml" to variable "TRANSACTION_TEMPLATE_02"
    And I assign "006_R5.IN-25A BRS_Trade_Nugget_TH_TFUND_Transaction_Prerequisite_02.xml" to variable "TRANSACTION_FILE_02"

    #Publish files & directory
    And I assign "006_Trade_Nugget_TH_TFUND_Transaction_Template_Publish_02.qqq" to variable "PUBLISH_FILE_TEMPLATE_02"
    And I assign "006_Trade_Nugget_TH_TFUND_Transaction_Expected_Publish_02.qqq" to variable "PUBLISH_FILE_EXPECTED_02"
    And I assign "006_Trade_Nugget_TH_TFUND_Transaction_Actual_Publish_01" to variable "PUBLISH_FILE_ACTUAL_01"
    And I assign "006_Trade_Nugget_TH_TFUND_Transaction_Actual_Publish_02" to variable "PUBLISH_FILE_ACTUAL_02"
