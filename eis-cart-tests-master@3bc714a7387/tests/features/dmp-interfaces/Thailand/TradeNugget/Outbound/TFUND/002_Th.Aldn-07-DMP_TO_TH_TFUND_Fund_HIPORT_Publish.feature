...
# Purpose : The purpose of this file to publish on market transactions(Fund) from DMP to TFUND hiport.
...
@eisdev_6363 @eisdev_6363_tfund_fund @001_tfund_onmarket_publish @dmp_thailand_hiport @dmp_thailand
@eisdev_6426 @eisdev_6430 @eisdev_5921 @eisdev_6480 @eisdev_6580 @eisdev_6655 @eisdev_6696 @eisdev_6725
@eisdev_6824 @eisdev_6829

Feature: Publish the TFund Mutual Fund trade in Hiport format

  This feature will test the below scenarios
  1. Load Portfolio files to create portfolios
  2. Load the Fund security file received as part of the trade nugget
  3. Load the Fund transaction file received as part of the trade nugget
  4. Publish the Fund HiPort file

  Security_ID   | Fund_ID | Transaction_ID            | Transaction_Type | Transaction_Date |
  IDN000418308  | 217     | BHTFDT303${TRD_VAR_NUM_1} | SELL             | ${CURR_DATE_1}   |
  BRT7MMZB9     | 217     | BHTFDT404${TRD_VAR_NUM_1} | BUY              | ${CURR_DATE_1}   |
  IDN000418308  | 217     | BHTFDT505${TRD_VAR_NUM_1} | SELL             | ${CURR_DATE_1}   |
  ...
  Scenario:TC1: Initialize all the variables
    ...
    And I assign "002_Th_Aldn-07-DMP_TO_TH_TFTXNFD_Template.qqq" to variable "PUBLISH_FILE_TEMPLATE"
    And I assign "002_Th_Aldn-07-DMP_TO_TH_TFTXNFD_Expected" to variable "PUBLISH_FILE_EXPECTED"
    And I assign "002_Th_Aldn-07-DMP_TO_TH_TFTXNFD_Actual" to variable "PUBLISH_FILE_ACTUAL"
