...
@eisdev_6416 @011_tfund_onmarket_publish @dmp_thailand_hiport @dmp_thailand @eisdev_7172 @eisdev_7492
Feature: The trades with tran type other than MAT are only published
  ...
  Scenario: TC1: Initialize all the variables
   ...
   #Security Files
    And I assign "011_R5.IN-25A BRS_Trade_Nugget_TH_TFUND_Security_Template.xml" to variable "SECURITY_TEMPLATE"
    And I assign "011_R5.IN-25A BRS_Trade_Nugget_TH_TFUND_Security_Prerequisite.xml" to variable "SECURITY_FILE"
    ...
    #Transaction Files
    And I assign "011_R5.IN-25A BRS_Trade_Nugget_TH_TFUND_Transaction_Template.xml" to variable "TRANSACTION_TEMPLATE"
    And I assign "011_R5.IN-25A BRS_Trade_Nugget_TH_TFUND_Transaction_Prerequisite.xml" to variable "TRANSACTION_FILE"

    #Publish files & directory
    And I assign "011_Trade_Nugget_TH_TFUND_Transaction_Template_Publish.qqq" to variable "PUBLISH_FILE_TEMPLATE"
    And I assign "011_Trade_Nugget_TH_TFUND_Transaction_Expected_Publish.qqq" to variable "PUBLISH_FILE_EXPECTED"
    And I assign "011_Trade_Nugget_TH_TFUND_Transaction_Actual_Publish" to variable "PUBLISH_FILE_ACTUAL"
