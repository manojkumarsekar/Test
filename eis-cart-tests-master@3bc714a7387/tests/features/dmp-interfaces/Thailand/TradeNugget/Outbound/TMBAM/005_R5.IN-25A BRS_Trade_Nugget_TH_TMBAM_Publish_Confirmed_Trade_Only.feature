...
@eisdev_6416 @005_tmbam_onmarket_publish @dmp_thailand_hiport @dmp_thailand @eisdev_6877
Feature: Publish only confirmed trade to Hiport
  ...
  A new confirmed trade for a portfolio not in Port group THB-AG
  A new confirmed trade for a portfolio not in portgroup ES-MUT
  ...
  5. Verify only the new confirmed trade is published
  ...
  Scenario: TC1: Initialize all the variables
    ...
    #Portfolio Files
    And I assign "005_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Portfolio_Template.xml" to variable "PORTFOLIO_TEMPLATE"
    And I assign "005_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Portfolio_Prerequisite.xml" to variable "PORTFOLIO_FILE"

    #Transaction Files as prerequisite
    And I assign "005_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Transaction_Template_01.xml" to variable "TRANSACTION_TEMPLATE_01"
    And I assign "005_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Transaction_Prerequisite_01.xml" to variable "TRANSACTION_FILE_01"

    #Transaction Files with test data
    And I assign "005_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Transaction_Template_02.xml" to variable "TRANSACTION_TEMPLATE_02"
    And I assign "005_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Transaction_Prerequisite_02.xml" to variable "TRANSACTION_FILE_02"

    #Publish files & directory
    And I assign "005_Trade_Nugget_TH_TMBAM_Transaction_Template_Publish_02.qqq" to variable "PUBLISH_FILE_TEMPLATE_02"
    And I assign "005_Trade_Nugget_TH_TMBAM_Transaction_Expected_Publish_02.qqq" to variable "PUBLISH_FILE_EXPECTED_02"
    And I assign "005_Trade_Nugget_TH_TMBAM_Transaction_Actual_Publish_01" to variable "PUBLISH_FILE_ACTUAL_01"
    And I assign "005_Trade_Nugget_TH_TMBAM_Transaction_Actual_Publish_02" to variable "PUBLISH_FILE_ACTUAL_02"
...
#Trigger publish to clear any unpublished files
  ...
  Scenario: TC6: Load the two prerequisite trades into DMP
  ...
  Scenario: TC10: Verify only the confirmed trade is published
