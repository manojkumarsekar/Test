...
# Purpose : The purpose of this file to publish on market transactions(Equity) from DMP to TMBAM hiport.
...
# EISDEV-6965 Changes --START--
# XN_NATIVE_BROKERAGE & XN.NATIVE_STAMP
# EISDEV-6965 Changes --END--

@gc_interface_trades @gc_interface_portfolios @gc_interface_transactions @gc_interface_securities
@dmp_regression_integrationtest
@eisdev_6363 @eisdev_6363_tmbam_equity @001_tmbam_onmarket_publish @dmp_thailand_hiport @dmp_thailand
@eisdev_6426 @eisdev_6430 @eisdev_5921 @eisdev_6480 @eisdev_6696 @eisdev_6725 @eisdev_6765 @eisdev_6824 @eisdev_6829
@eisdev_6814 @eisdev_6952 @eisdev_6965

Feature: Publish the TMBAM Equity trade in Hiport format
  ...
  SG1U68934629  | TMB22     | BHTMBT101${TRD_VAR_NUM_1} | SELL             | ${CURR_DATE_1}   |
  KR7035720002  | TMB22     | BHTMBT202${TRD_VAR_NUM_1} | BUY              | ${CURR_DATE_1}   |
  SG1U68934629  | TMB22_S   | BHTMBT103${TRD_VAR_NUM_1} | SELL             | ${CURR_DATE_1}   |
  ...
  Scenario:TC1: Initialize all the variables
    ...
    And I assign "001_Th_Aldn-07-DMP_TO_TH_TMBTXNEQ_Template.qqq" to variable "PUBLISH_FILE_TEMPLATE"
    And I assign "001_Th_Aldn-07-DMP_TO_TH_TMBTXNEQ_Expected" to variable "PUBLISH_FILE_EXPECTED"
    And I assign "001_Th_Aldn-07-DMP_TO_TH_TMBTXNEQ_Actual" to variable "PUBLISH_FILE_ACTUAL"
  ...
  Scenario:TC6: Publish the Equity file in Hiport format
  ...
  Scenario: TC7: Recon the Equity published file against the expected file
