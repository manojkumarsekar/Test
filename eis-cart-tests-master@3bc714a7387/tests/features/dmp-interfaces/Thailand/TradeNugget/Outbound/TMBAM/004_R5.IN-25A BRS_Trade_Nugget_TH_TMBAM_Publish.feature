...
@eisdev_6416 @004_tmbam_onmarket_publish @dmp_thailand_hiport @dmp_thailand @eisdev_6846 @eisdev_6877 @eisdev_6952 @eisdev_7172 @eisdev_7492
Feature: Publish the trade file in the Hiport format for TMBAM
  ...
  Scenario: TC1: Initialize all the variables
    ...
    #Issuer Files
    And I assign "004_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Issuer_Template.xml" to variable "ISSUER_TEMPLATE"
    And I assign "004_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Issuer_Prerequisite.xml" to variable "ISSUER_FILE"

    #Counterparty Files
    And I assign "004_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Broker_Template.xml" to variable "COUNTERPARTY_TEMPLATE"
    And I assign "004_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Broker_Prerequisite.xml" to variable "COUNTERPARTY_FILE"

    #Security Files
    And I assign "004_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Security_Template.xml" to variable "SECURITY_TEMPLATE"
    And I assign "004_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Security_Prerequisite.xml" to variable "SECURITY_FILE"
    ...
    #Transaction Files
    And I assign "004_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Transaction_Template.xml" to variable "TRANSACTION_TEMPLATE"
    And I assign "004_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Transaction_Prerequisite.xml" to variable "TRANSACTION_FILE"

    #Publish files
    And I assign "004_Trade_Nugget_TH_TMBAM_Transaction_Template_Publish" to variable "PUBLISH_FILE_TEMPLATE"
    And I assign "004_Trade_Nugget_TH_TMBAM_Transaction_Actual_Publish" to variable "PUBLISH_FILE_ACTUAL"
    And I assign "004_Trade_Nugget_TH_TMBAM_Transaction_Expected_Publish" to variable "PUBLISH_FILE_EXPECTED"
  ...
  Scenario Outline: TC2: Publish any unpublished files to clear the log
    ...
    Examples:
      ...
      | Equity     | EITH_DMP_TO_TMBAM_HIPORT_TRADE_EQ_SUB   | /dmp/out/thailand/intraday |
      | Fund       | EITH_DMP_TO_TMBAM_HIPORT_TRADE_FUND_SUB | /dmp/out/thailand/intraday |
      | Bond       | EITH_DMP_TO_TMBAM_HIPORT_TRADE_FI_SUB   | /dmp/out/thailand/intraday |
      | Cash       | EITH_DMP_TO_TMBAM_HIPORT_TRADE_CASH_SUB | /dmp/out/thailand/intraday |
  ...
  Scenario: TC4: Load the Issuer file in the trade nugget
    ...
    Given I create input file "${ISSUER_FILE}" using template "${ISSUER_TEMPLATE}" from location "${testdata.path}/Outbound/TMBAM/inputfiles"

    When I process "${testdata.path}/Outbound/TMBAM/inputfiles/testdata/${ISSUER_FILE}" file with below parameters
  ...
  Scenario: TC5: Load the Broker file in the trade nugget
    ...
    Given I create input file "${COUNTERPARTY_FILE}" using template "${COUNTERPARTY_TEMPLATE}" from location "${testdata.path}/Outbound/TMBAM/inputfiles"

    When I process "${testdata.path}/Outbound/TMBAM/inputfiles/testdata/${COUNTERPARTY_FILE}" file with below parameters
  ...
  Scenario: TC8: Load the Transaction file in the trade nugget
    ...
    Given I create input file "${TRANSACTION_FILE}" using template "${TRANSACTION_TEMPLATE}" from location "${testdata.path}/Outbound/TMBAM/inputfiles"

    When I process "${testdata.path}/Outbound/TMBAM/inputfiles/testdata/${TRANSACTION_FILE}" file with below parameters
      | FILE_PATTERN  | ${TRANSACTION_FILE}                |
      | MESSAGE_TYPE  | EIS_MT_BRS_TH_INTRADAY_TRANSACTION |
      | BUSINESS_FEED |                                    |

    Then I expect workflow is processed in DMP with success record count as "16"
  ...
  Scenario Outline: TC9: Publish the trade file in HiPort format for each asset class and compare with expected
    ...
    Then I expect below files to be present in the host "dmp.ssh.inbound" into folder "<PUBLISHING_DIRECTORY>" after processing:
      | ${PUBLISH_FILE_ACTUAL}_<AssetClass>*.qqq |
    ...
    And I create input file "${PUBLISH_FILE_EXPECTED}_<AssetClass>.qqq" using template "${PUBLISH_FILE_TEMPLATE}_<AssetClass>.qqq" from location "${testdata.path}/Outbound/TMBAM/outfiles"

    Then I expect file "${testdata.path}/Outbound/TMBAM/outfiles/testdata/${PUBLISH_FILE_ACTUAL}_<AssetClass>_${DYNAMIC_FILE_DATE}_1.qqq" should have below columns
      | IDXITRI-H  |
      | THB        |
      | <Filename> |
      | qqq        |
    ...
    And I expect all records from file1 of type QQQ exists in file2
      | File1 | ${testdata.path}/Outbound/TMBAM/outfiles/testdata/${PUBLISH_FILE_EXPECTED}_<AssetClass>.qqq                      |
      | File2 | ${testdata.path}/Outbound/TMBAM/outfiles/testdata/${PUBLISH_FILE_ACTUAL}_<AssetClass>_${DYNAMIC_FILE_DATE}_1.qqq |

    Examples:
      | AssetClass | AssetClassPublishingProfile             | PUBLISHING_DIRECTORY       | Filename |
      | Equity     | EITH_DMP_TO_TMBAM_HIPORT_TRADE_EQ_SUB   | /dmp/out/thailand/intraday | TMBTXNEQ |
      | Fund       | EITH_DMP_TO_TMBAM_HIPORT_TRADE_FUND_SUB | /dmp/out/thailand/intraday | TMBTXNFD |
      | Bond       | EITH_DMP_TO_TMBAM_HIPORT_TRADE_FI_SUB   | /dmp/out/thailand/intraday | TMBTXNFI |
      | Cash       | EITH_DMP_TO_TMBAM_HIPORT_TRADE_CASH_SUB | /dmp/out/thailand/intraday | TMBCASH  |
