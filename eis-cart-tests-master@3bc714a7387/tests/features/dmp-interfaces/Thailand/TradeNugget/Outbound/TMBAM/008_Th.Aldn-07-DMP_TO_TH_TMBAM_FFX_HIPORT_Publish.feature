...
#Purpose : The purpose of this file to publish ffx transactions(fx) from DMP to TMBAM hiport.
...
@eisdev_6469 @eisdev_6469_tmbam_ffx @001_tmbam_ffx_publish @dmp_thailand_hiport @dmp_thailand
@eisdev_6575 @eisdev_6589 @eisdev_6696 @eisdev_6725 @eisdev_6772 @eisdev_6794 @eisdev_6829 @eisdev_6814

Feature: Publish the TMBAM FFX trade in Hiport format
  ...
  BES3B5TL2     | TMB22     | TMFXSPOT111${TRD_VAR_NUM_1} | BUY               | ${CURR_DATE_1}    | ES-MUT
  BES3B5VA3     | TMB22     | TMFXSPOT222${TRD_VAR_NUM_1} | SELL              | ${CURR_DATE_1}    | ES-MUT
  BES3B5TL2     | TMB10     | TMFXSPOT333${TRD_VAR_NUM_1} | BUY               | ${CURR_DATE_1}    | ES-PVF
  BES3B5VA3     | TMB10     | TMFXSPOT444${TRD_VAR_NUM_1} | SELL              | ${CURR_DATE_1}    | ES-PVF
  BES3B5TL2     | TMB22     | TMFXSPOT555${TRD_VAR_NUM_1} | MAT-              | ${CURR_DATE_1}    | ES-MUT
  BES3B5VA3     | TMB22     | TMFXSPOT666${TRD_VAR_NUM_1} | MAT+              | ${CURR_DATE_1}    | ES-MUT
  BES3B5TL2     | TMB22_S   | TMFXSPOT777${TRD_VAR_NUM_1} | BUY               | ${CURR_DATE_1}    | ES-MUT

  SecGroup : FX  | SecType : FWRD
  Security_ID   | Fund_ID   | Transaction_ID                | Transaction_Type  | Transaction_Date  | Group
  BES3B6US3     | TMB22     | TMFXFWRD111${TRD_VAR_NUM_1}   | BUY               | ${CURR_DATE_1}    | ES-MUT
  BES3B6UR5     | TMB22     | TMFXFWRTMB222${TRD_VAR_NUM_1} | SELL              | ${CURR_DATE_1}    | ES-MUT
  BES3B6US3     | TMB10     | TMFXFWRD333${TRD_VAR_NUM_1}   | BUY               | ${CURR_DATE_1}    | ES-PVF
  BES3B6UR5     | TMB10     | TMFXFWRD444${TRD_VAR_NUM_1}   | SELL              | ${CURR_DATE_1}    | ES-PVF
  BES3B6US3     | TMB22     | TMFXFWRD555${TRD_VAR_NUM_1}   | MAT-              | ${CURR_DATE_1}    | ES-MUT
  BES3B6UR5     | TMB22     | TMFXFWRD666${TRD_VAR_NUM_1}   | MAT+              | ${CURR_DATE_1}    | ES-MUT
  BES3B6US3     | TMB22_S   | TMFXFWRD777${TRD_VAR_NUM_1}   | BUY               | ${CURR_DATE_1}    | ES-MUT
  ...
  Scenario:TC1: Initialize all the variables
    ...
    And I assign "008_Th_Aldn-07-DMP_TO_TH_TMBFFX_Template.qqq" to variable "PUBLISH_FILE_TEMPLATE"
    And I assign "008_Th_Aldn-07-DMP_TO_TH_TMBFFX_Expected" to variable "PUBLISH_FILE_EXPECTED"
    And I assign "008_Th_Aldn-07-DMP_TO_TH_TMBFFX_Actual" to variable "PUBLISH_FILE_ACTUAL"
  ...
  Scenario: TC2: Publish any unpublished files to clear the log
    ...
    And I process publishing wrapper with below parameters and wait for the job to be completed
      ...
      | SUBSCRIPTION_NAME           | EITH_DMP_TO_TMBAM_HIPORT_TRADE_FFX_SUB |
      | FOOTER_COUNT                | 1                                      |
