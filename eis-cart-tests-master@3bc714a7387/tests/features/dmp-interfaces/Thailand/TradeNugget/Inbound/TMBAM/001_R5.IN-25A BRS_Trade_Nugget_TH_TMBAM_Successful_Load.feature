...
@eisdev_6416 @001_tmbam_onmarket_load @dmp_thailand_hiport @dmp_thailand
Feature: Load the trade nugget file and all associated files
  ...
  Scenario: TC1: Initialize all the variables
    ...
    #Issuer Files
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Issuer_Template.xml" to variable "ISSUER_TEMPLATE"
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Issuer_Prerequisite.xml" to variable "ISSUER_FILE"

    #Counterparty Files
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Broker_Template.xml" to variable "COUNTERPARTY_TEMPLATE"
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Broker_Prerequisite.xml" to variable "COUNTERPARTY_FILE"

    #Security Files
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Security_Template.xml" to variable "SECURITY_TEMPLATE"
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Security_Prerequisite.xml" to variable "SECURITY_FILE"

    #Portfolio Files
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Portfolio_Template.xml" to variable "PORTFOLIO_TEMPLATE"
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Portfolio_Prerequisite.xml" to variable "PORTFOLIO_FILE"

    #Transaction Files
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Transaction_Template.xml" to variable "TRANSACTION_TEMPLATE"
    And I assign "001_R5.IN-25A BRS_Trade_Nugget_TH_TMBAM_Transaction_Prerequisite.xml" to variable "TRANSACTION_FILE"
    ...
    #Create Portfolio
  Scenario: TC2: Create the test portfolio and add the portfolio into THB-AG group
  ...
  Scenario: TC3: Load the Issuer file in the trade nugget
    ...
    Given I create input file "${ISSUER_FILE}" using template "${ISSUER_TEMPLATE}" from location "${testdata.path}/Inbound/TMBAM"

    When I process "${testdata.path}/Inbound/TMBAM/testdata/${ISSUER_FILE}" file with below parameters
  ...
  Scenario: TC4: Load the Broker file in the trade nugget
    ...
    Given I create input file "${COUNTERPARTY_FILE}" using template "${COUNTERPARTY_TEMPLATE}" from location "${testdata.path}/Inbound/TMBAM"

    When I process "${testdata.path}/Inbound/TMBAM/testdata/${COUNTERPARTY_FILE}" file with below parameters
  ...
  Scenario: TC5: Load the Security file in the trade nugget
    ...
    Given I create input file "${SECURITY_FILE}" using template "${SECURITY_TEMPLATE}" from location "${testdata.path}/Inbound/TMBAM"

    When I process "${testdata.path}/Inbound/TMBAM/testdata/${SECURITY_FILE}" file with below parameters
  ...
  Scenario: TC6: Load the Portfolio file in the trade nugget
    ...
    Given I create input file "${PORTFOLIO_FILE}" using template "${PORTFOLIO_TEMPLATE}" from location "${testdata.path}/Inbound/TMBAM"

    When I process "${testdata.path}/Inbound/TMBAM/testdata/${PORTFOLIO_FILE}" file with below parameters
  ...
  Scenario: TC7: Load the Transaction file in the trade nugget
    ...
    Given I create input file "${TRANSACTION_FILE}" using template "${TRANSACTION_TEMPLATE}" from location "${testdata.path}/Inbound/TMBAM"

    When I process "${testdata.path}/Inbound/TMBAM/testdata/${TRANSACTION_FILE}" file with below parameters
  ...
  """
    ...
    FROM FT_T_EXTR WHERE ACCT_ID IN (SELECT ACCT_ID FROM FT_T_ACID WHERE ACCT_ALT_ID ='TST-TMB10')
  ...
  """
    ...
    Examples:
      ...
      | Equity     | BRT8GK778 | 16410-TRD1${VAR_RANDOM} |
      | Fund       | S02461051 | 16410-TRD2${VAR_RANDOM} |
      | Bond       | BPM0QXVX3 | 16410-TRD3${VAR_RANDOM} |
  ...
  """
    ...
    Examples:
      ...
      | Equity     | AOT      | 16410-TRD1${VAR_RANDOM} | 1     |
      | Fund       | PIMGBAI  | 16410-TRD2${VAR_RANDOM} | 1     |
      | Bond       | NTL205AY | 16410-TRD3${VAR_RANDOM} | 1     |
