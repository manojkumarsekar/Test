...
#EISDEV_4693 : Updated template for new field mapping TOP_PARENT_FUND_ID. Also added a use case of Parent-Child Portfolio
#Uncommented feature file as the directory is present now.
#EISDEV_4834 : Utility to generate trade file by Fund for Exception Handling Adhoc publishing profile created

@tom_3977 @dmp_portfolio_group @dmp_regression_integrationtest @eisdev_4693 @eisdev_4834

Feature: Outbound Portfolio Group Interface Testing for HSBC TW (R5.IN-CAS14)
  ...
  This and the equivalent SSB feature file also demonstrate that the subsscription profiles have been configured correctly.
  ...
  Scenario: TC_2: Extract port group participants for domestic fund group
    ...
    And I assign "/dmp/out/hsbc" to variable "PUBLISHING_DIR"
    ...
    When I process publishing wrapper with below parameters and wait for the job to be completed
      ...
      | SUBSCRIPTION_NAME    | EITW_DMP_TO_HSBC_DOMESTIC_PORT_SUB |
  ...
  Scenario: TC_4: Extract port group participants for overseas fund group
    ...
    When I process publishing wrapper with below parameters and wait for the job to be completed
      | PUBLISHING_FILE_NAME | ${PUBLISHING_FILE_NAME}.csv        |
      | SUBSCRIPTION_NAME    | EITW_DMP_TO_HSBC_OVERSEAS_PORT_SUB |
  ...
  Scenario: TC_6: Extract port group participants for Adhoc publishing job
    ...
    When I process publishing wrapper with below parameters and wait for the job to be completed
      ...
      | SUBSCRIPTION_NAME    | EITW_DMP_TO_HSBC_PORT_ADHOC_SUB   |
  ...
  Scenario: TC_8: Teardown test data for overseas fund group
