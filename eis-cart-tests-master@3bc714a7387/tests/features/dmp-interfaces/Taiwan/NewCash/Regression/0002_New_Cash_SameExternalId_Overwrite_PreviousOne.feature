...
#TOM-4394 : Split inbound file into two, to avoid overwriting records being loaded too quickly, and conflicting with AOI processing

@gc_interface_portfolios @gc_interface_cash
@dmp_regression_integrationtest
@dmp_taiwan
@tom_3645 @taiwan_newcash @taiwan_newcash_sameexternid @tom_4223 @tom_4394
Feature: Outbound new cash from DMP to BRS Interface Testing same EXTERN_NEWCASH_ID1 overwrites previous one (R5.IN-CAS9 DMP->BRS Intraday New Cash Transactions)
  ...
  TEST_20180521_00064,3000,CASHIN,TWD,20180521,20180521,TST-TRD5-SH-CLUBN_005,,E
  TEST_20180521_00064,3000,CASHOUT,TWD,20180521,20180521,TST-TRD5-SH-CLUBN_005,,F
  ...
  Scenario: TC_1: Clear the Taiwan Cash data as a Prerequisite and set up account in DMP
    ...
    Given I assign "0002_TW_newcash_Same_ExternalID_A.csv" to variable "INPUT_FILENAME_A"
    And I assign "0002_TW_newcash_Same_ExternalID_B.csv" to variable "INPUT_FILENAME_B"
    ...
    And I assign "esi_TW_newcash_outbound_sameexternalID" to variable "PUBLISHING_FILE_NAME"
    And I generate value with date format "YYYYMMdd" and assign to variable "VAR_SYSDATE"
    And I assign "/dmp/out/brs/intraday" to variable "PUBLISHING_DIR"
    And I assign "0002_expected_output_SameExternalID.csv" to variable "NEW_CASH_MASTER_TEMPLATE"
  ...
  Scenario: TC_2: Load Taiwan New Cash Files with same externalid with different portfolio, it should overwrite the previous load with new one and publish
