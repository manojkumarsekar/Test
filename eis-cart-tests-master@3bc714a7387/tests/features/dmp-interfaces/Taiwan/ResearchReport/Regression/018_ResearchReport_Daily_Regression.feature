...
@dmp_taiwan
@tom_3876 @018_rr_basic_tests @dmp_twrr_regression
Feature: Test Research Report for different category

  This feature is an extract of 018_ResearchReport_Full_Regression.feature,
  considering only four scenarios from parent feature and tagged as dmp_regression (runs daily)
  ...
  Scenario: TC2:Load portfolio Template with Main portfolio details to Setup new accounts in DMP
    ...
    And I execute below query to "Insert row into ACGP for TW fund group ESI_TW_PROD"
    """
