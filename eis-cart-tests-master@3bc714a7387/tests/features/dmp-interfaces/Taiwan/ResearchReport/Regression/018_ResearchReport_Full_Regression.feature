...
#https://jira.intranet.asia/browse/TOM-3876

@dmp_taiwan
@tom_3876
Feature: Test Research Report for different category
  ...
  This feature will test end to end workflow for all different category to check workflow is working as expected
  ...
  Scenario Outline: validate research report for categoty <CategoryTemplate> and scenario <ReportScenario>
    ...
    Examples: Order Parameters
      ...
      | Report tagged (Buy) _S order portfolio     | DEQTemplate.txt        | 2345             | 5150             | 3750        | Buy           | U_TT56          | TT56                | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | U_TT56_S        | 1000     | ESI. TW DEQ Buy Sell          | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
      | TargetUpperPrice > Reportprice * 140%(Buy) | DAMTemplate.txt        | 2345             | 5678             | 3750        | Buy           | TSTTT16         | TT16                | SBD5DMY28     | SBD5DMY28 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW DAM Buy Sell          | 100        | 200         | false        | TWRES_TP_INVAL  | ${INTERNAL_LINK} |
      | Report Fund Invalid (Buy)                  | OEQTemplate.txt        | 2345             | 5150             | 3750        | Buy           | ATAPIF          | TSTTT16             | SBFYFZP55     | SBFYFZP55 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW OEQ Buy Sell          | 3750       | 200         | false        | TWRES_FD_INVAL  | ${INTERNAL_LINK} |
      | LimitPrice < TargetLowerPrice(Sell)        | OEQIncomeTemplate.txt  | 2345             | 5240             | 3750        | Sell          | TSTTT16         | TT16                | SBF55Y570     | SBF55Y570 | SELL     | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW OEQ Income Buy Sell   | 100        | 200         | false        | TWRES_PX_MISMAT | ${INTERNAL_LINK} |
      | Report tagged (Buy)                        | OEQGCInfraTemplate.txt | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TT16                | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW OEQ GC Infra Buy Sell | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
      | Report not found (Buy vs SELL)             | OEQGemTemplate.txt     | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TT16                | S67484238     | S67484238 | SELL     | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW OEQ GEM Buy Sell      | 3750       | 200         | false        | TW_RES_NOTFOUND |                  |
      | Report tagged (Sell)                       | GFITemplate.txt        | 2345             | 5150             | 3750        | Sell          | TSTTT16         | TT16                | SB1VJS642     | SB1VJS642 | SELL     | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW GFI Buy Sell          | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
      | Report tagged (Buy)                        | MFMMTemplate.txt       |                  |                  |             |               | TSTTT16         | TT16                |               | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW MF Money Market       | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
      | Report tagged (Buy)                        | MFQuantTemplate.txt    |                  |                  |             |               | U_TT56          | TT16                |               | SB1VJS642 | BUY      | TEST_API_ORDER | U_TT56          | 1000     | ESI. TW MF Quant              | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
      | Report tagged (Sell)                       | MFProrataTemplate.txt  |                  |                  |             |               | U_TT56          | TT16                |               | SB1VJS642 | SELL     | TEST_API_ORDER | U_TT56_S        | 1000     | ESI. TW MF Prorata Rebal      | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
