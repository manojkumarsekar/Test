...
@dmp_taiwan
@eisdev_6681
Feature: Test Research Report for different category daily regression new format

  This feature is an extract of 020_ResearchReport_Full_Regression.feature,
