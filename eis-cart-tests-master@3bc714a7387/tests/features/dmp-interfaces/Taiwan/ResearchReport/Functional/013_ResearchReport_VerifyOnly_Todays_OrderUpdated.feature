...
Feature: Test Research Report to update only Todays orders
  ...
  Scenario Outline: validate research report is updating only todays orders for categoty <CategoryTemplate> and scenario <ReportScenario>
    ...
    And I assign "esi_orders_New_TodayUpdated_${VAR_RANDOM}.xml" to variable "ORDER_INPUT_FILENAME"
    ...
    #change start tms of order to old date
    And I execute below query
    """
    UPDATE FT_T_AOST SET STAT_TMS = STAT_TMS - 2,
    LAST_CHG_USR_ID = LAST_CHG_USR_ID|| 'AUTOMATION',
    LAST_CHG_TMS = SYSDATE WHERE AUOR_OID IN
    (select AUOR_OID from gs_gc.FT_T_AUOR  where PREF_ORDER_ID IN ('${ORDER_NUMBER}') AND ACCT_ID is null);
    COMMIT
    """
    ...
    Examples: Order Parameters
      ...
      | DEQTemplate.txt        | Update only today orders | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TT16                | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW DEQ Buy Sell          | 3750       | 200         | false        | TW_RES_TAGGED | ${INTERNAL_LINK} |
      | DAMTemplate.txt        | Update only today orders | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TD00105             | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW DAM Buy Sell          | 3750       | 200         | false        | TW_RES_TAGGED | ${INTERNAL_LINK} |
      | OEQTemplate.txt        | Update only today orders | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TT16                | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW OEQ Buy Sell          | 3750       | 200         | false        | TW_RES_TAGGED | ${INTERNAL_LINK} |
      | OEQIncomeTemplate.txt  | Update only today orders | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TT16                | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW OEQ Income Buy Sell   | 3750       | 200         | false        | TW_RES_TAGGED | ${INTERNAL_LINK} |
      | OEQGCInfraTemplate.txt | Update only today orders | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TT16                | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW OEQ GC Infra Buy Sell | 3750       | 200         | false        | TW_RES_TAGGED | ${INTERNAL_LINK} |
      | OEQGemTemplate.txt     | Update only today orders | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TT16                | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW OEQ GEM Buy Sell      | 3750       | 200         | false        | TW_RES_TAGGED | ${INTERNAL_LINK} |
      | GFITemplate.txt        | Update only today orders | 2345             | 5150             | 3750        | Buy           | TSTTT16         | TT16                | SB1VJS642     | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW GFI Buy Sell          | 3750       | 200         | false        | TW_RES_TAGGED | ${INTERNAL_LINK} |
