...
Feature: Test Research Report for TW MF Money Market
  ...
  This feature will test all the scenarios for MM category as mentioned in the requirement
  Expected Result: Research report workflow will load the MM report and update order status PM instruction and Int comment
  ...
  Scenario Outline: validate research report for categoty TW MF Money Market and scenario <ReportScenario>
    ...
    And I assign "esi_orders_New_MM_${VAR_RANDOM}.xml" to variable "ORDER_INPUT_FILENAME"
    ...
    Examples: Order Parameters
      ...
      | MFMMTemplate.txt | Report tagged (Buy)                                          | TSTTT16         | TT16                | SB1VJS642 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW MF Money Market | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
      | MFMMTemplate.txt | Report tagged (Sell)                                         | TSTTT16         | TT16                | SB1VJS642 | SELL     | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW MF Money Market | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
      | MFMMTemplate.txt | Report not found (Buy,Trade purpose not DEQ)                 | TSTTT16         | TT16                | SB59NHY78 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW FX Sub to Main  | 3750       | 200         | false        | TW_RES_NOTFOUND |                  |
      | MFMMTemplate.txt | Report not found (Sell,Trade purpose not DEQ)                | TSTTT16         | TT16                | SB59NHY78 | SELL     | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW FX Sub to Main  | 3750       | 200         | true         | TW_RES_NOTFOUND |                  |
      | MFMMTemplate.txt | Report not found (Buy,Trade purpose blank)                   | TSTTT16         | TT16                | SB59NHY78 | SELL     | TEST_API_ORDER | TSTTT16         | 1000     |                         | 3750       | 200         | true         | TW_RES_NOTFOUND |                  |
      | MFMMTemplate.txt | Report not found (Sell,Trade purpose blank)                  | TSTTT16         | TT16                | SB59NHY78 | SELL     | TEST_API_ORDER | TSTTT16         | 1000     |                         | 3750       | 200         | false        | TW_RES_NOTFOUND |                  |
      | MFMMTemplate.txt | MM without portfolio: Report tagged (Buy) (EISTOMTEST-4043)  |                 |                     | SB01QKV73 | BUY      | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW MF Money Market | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
      | MFMMTemplate.txt | MM without portfolio: Report tagged (Sell) (EISTOMTEST-4043) |                 |                     | SB01RM254 | SELL     | TEST_API_ORDER | TSTTT16         | 1000     | ESI. TW MF Money Market | 3750       | 200         | false        | TW_RES_TAGGED   | ${INTERNAL_LINK} |
