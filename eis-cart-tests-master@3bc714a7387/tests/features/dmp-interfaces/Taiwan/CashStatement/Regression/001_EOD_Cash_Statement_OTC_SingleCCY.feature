...
@dmp_taiwan
@tom_3390 @taiwan_cash_statement @tw_cashstatement_otc_singleccy @tom_4075
Feature: Load cash statement from OCR to DMP with Opening balance, Transactions and Closing Balance for single portfolio and single currency
  ...
  Scenario: TC1: Clear old test data and setup variables
    ...
    And I assign "001_EODCash_OTC_SingleCCY_Day1_Template.csv" to variable "INPUT_FILENAME_DAY1_TEMPLATE"
    And I assign "001_EODCash_OTC_SingleCCY_Day1.csv" to variable "INPUT_FILENAME_DAY1"
    And I assign "001_EODCash_OTC_SingleCCY_Day2_Template.csv" to variable "INPUT_FILENAME_DAY2_TEMPLATE"
    And I assign "001_EODCash_OTC_SingleCCY_Day2.csv" to variable "INPUT_FILENAME_DAY2"
    And I assign "001_EODCash_OTC_SingleCCY_ExpectedOutput1.csv" to variable "OUTPUT_DAY1_TEMPLATE"
    And I assign "001_EODCash_OTC_SingleCCY_Day1_Output.csv" to variable "OUTPUT_FILENAME_DAY1"
    And I assign "001_EODCash_OTC_SingleCCY_ExpectedOutput2.csv" to variable "OUTPUT_DAY2_TEMPLATE"
    And I assign "001_EODCash_OTC_SingleCCY_Day2_Output.csv" to variable "OUTPUT_FILENAME_DAY2"
    And I assign "/dmp/out/brs" to variable "PUBLISHING_DIRECTORY"
    And I assign "001_EODCash_OTC_BRSFile" to variable "PUBLISHING_FILE_NAME"
  ...
  Scenario: TC2: Load cash statement file for portfolio "PRU_FM_FI_PIF-HIG" and currency "EUR" Day1
  ...
  Scenario: TC3: Load cash statement file for portfolio "PRU_FM_FI_PIF-HIG" and currency "EUR" Day2 (Change in Amount field)
