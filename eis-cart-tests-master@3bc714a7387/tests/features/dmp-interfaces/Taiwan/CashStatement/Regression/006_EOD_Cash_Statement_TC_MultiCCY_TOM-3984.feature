...
@dmp_taiwan
@tom_3390 @taiwan_cash_statement @tw_cashstatement_tc_multiccy @tom_4075
Feature: Load cash statement from OCR to DMP with Transactions and Closing Balance for single portfolio and multiple currency
  ...
  Scenario: TC1: Clear old test data and setup variables
    ...
    And I assign "006_EODCash_TC_MultiCCY_Template.csv" to variable "INPUT_FILENAME_TEMPLATE"
    And I assign "006_EODCash_TC_MultiCCY.csv" to variable "INPUT_FILENAME"
    And I assign "/dmp/out/brs" to variable "PUBLISHING_DIRECTORY"
    And I assign "006_EODCash_OTC_BRSFile" to variable "PUBLISHING_FILE_NAME"
    And I assign "006_EODCash_TC_MultiCCY_ExpectedOutput.csv" to variable "OUTPUT_TEMPLATE"
    And I assign "006_EODCash_TC_MultiCCY_Output.csv" to variable "OUTPUT_FILENAME"
  ...
  Scenario: TC2: Load cash statement file for portfolio "TT22" and currency "AUD,USD"
