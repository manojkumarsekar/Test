...
@tom_4095 @generateETFSI @tom_4538 @tom_4575 @tom_4585 @tw_settlement_instruction_format
@eisdev_7439

Feature: ETF settlement instruction report generation
  ...
  Scenario: Clear table data and setup variables
    ...
    """
     ...
     WHERE TRD_ID IN ('4267-SITEST11') AND END_TMS IS NULL;
     COMMIT
    """
    ...
    """
     ...
     WHERE EXEC_TRN_ID IN ('4267-SITEST11')
  ...
  Scenario: Load Portfolio, Security, Counterparty,trade file
    ...
    Given I assign "011_sm_Equity_ETF.xml" to variable "INPUT_FILENAME1"
    And I assign "broker.xml" to variable "INPUT_FILENAME2"
    And I assign "011_new_trade_CIS.xml" to variable "INPUT_FILENAME3"
  ...
  Scenario: Performing verifications
    ...
    """
      select count(*) TRANS_ROW_COUNT from ft_t_extr where trd_id ='4267-SITEST11' and end_tms is null
    """
    ...
    """
      ...
      WHERE TRD_ID = '4267-SITEST11' AND  END_TMS IS NULL
      )
    """
