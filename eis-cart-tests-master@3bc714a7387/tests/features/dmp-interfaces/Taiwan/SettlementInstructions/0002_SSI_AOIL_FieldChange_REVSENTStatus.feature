...
@tom_4095 @tom_4095_002_aoilfieldchange @tom_4476 @tw_settlement_instruction_format
@eisdev_7439

Feature: Test SSI report for one AOIL field change
  ...
  Scenario: Clear table data and setup variables
    ...
    """
     ...
     WHERE TRD_ID IN ('4267-SITEST2') AND END_TMS IS NULL;
     COMMIT
    """
    ...
    WHERE EXEC_TRN_ID IN ('4267-SITEST2
  ...
  Scenario: Load portfolio, security, broker and trade file
    ...
    And I assign "002_new_trade_CIS.xml" to variable "INPUT_FILENAME3"
  ...
  Scenario: Performing verifications
    ...
    """
      select count(*) TRANS_ROW_COUNT from ft_t_extr where trd_id ='4267-SITEST2' and end_tms is null
    """
    ...
    """
      ...
      WHERE TRD_ID = '4267-SITEST2' AND  END_TMS IS NULL
      )
    """
  ...
  Scenario:  Load Trades file after changing AOIL field - TRD_PRICE(EXTR.TRD_CPRC)

    Given I assign "002_AOIL_field_change_CIS.xml" to variable "INPUT_FILENAME"
    ...
    # Check if TRD_CPRC is changed succesfully
