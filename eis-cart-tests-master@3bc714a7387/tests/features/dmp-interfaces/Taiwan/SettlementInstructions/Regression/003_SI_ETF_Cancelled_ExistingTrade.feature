...
@tom_4085 @taiwan_settlement_instruction @si_etf_fund_cancel_trade @tom_4463 @tom_4494
Feature: Load new and Cancel Trade file in DMP and test SSI report generated for ETF funds based on requirement
  ...
  2.Cancellation of Trade file will generate settlement instruction
  ...
  Scenario: Prerequisite clear table data and setup variables
    ...
    And I assign "003_trade_etf_cancelled_template.xml" to variable "TRADE_INPUT_TEMPLATENAME"
  ...
  Scenario Outline: validate SSI report for ETF trade <SSIScenario>
    ...
    And I assign "001_trade_etf_confirmed_cancel_${VAR_RANDOM}.xml" to variable "TRADE_INPUT_FILENAME"
    ...
    And I expect value of column "EXST_PROCESSED_ROW_COUNT" in the below SQL query equals to "1":
      ...
      WHERE TRD_ID in ('3536-<TradeInvNum>') AND  END_TMS IS NULL
      )
      """
...
#      | BANK NAME:Test Bank Name                               |
    ...
    Examples: Trade Parameters
      | SSIScenario            | Cusip     | Isin     | TranType | TradeInvNum | TradeDate   | SettleDate  | TrdPortfolio      | TrdOriginalFace | TrdCounterParty      | Trdprincipal | TrdPrice | TrdCommission | TrdOtherFee | TrdCurrency | TrdTouchCount | TradeStatus | ReportStatus | ReportCopy     | ReportTradeDate | ReportSettleDate | ReportNetMoney | ReportCounterpartyName | ReportSecurityName |
      | Confirmed New Trade    | ${CUSIP1} | ${ISIN1} | BUY      | TEST_ETF    | ${VAR_DATE} | ${VAR_DATE} | ${PORTFOLIO_NAME} | 1000            | ${TRD_COUNTERPARTY1} | 14000        | 14       | 0             | 1.25        | TWD         | 1             |             | NEWSENT      |                | ${REPORT_DATE}  | ${REPORT_DATE}   | 14001.25       | ${COUNTERPARTY_NAME}   | ${SECURITY_DESC1}  |
      | Cancel confirmed trade | ${CUSIP1} | ${ISIN1} | BUY      | TEST_ETF    | ${VAR_DATE} | ${VAR_DATE} | ${PORTFOLIO_NAME} | 1000            | ${TRD_COUNTERPARTY1} | 14000        | 14       | 0             | 1.25        | TWD         | 2             | C           | CANCSENT     | CANCELLED COPY | ${REPORT_DATE}  | ${REPORT_DATE}   | 14001.25       | ${COUNTERPARTY_NAME}   | ${SECURITY_DESC1}  |
