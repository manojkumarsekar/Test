...
@tom_4095 @publishreport3rdrevision @tom_4538
Feature: settlement instruction report generation on 3rd revision
  ...
  Scenario: Clear table data and setup variables
   ...
   ${testdata.path}/sql/InsertAccount.sql
    ...
    """
     ...
     WHERE TRD_ID IN ('4267-SITEST10') AND END_TMS IS NULL;
     COMMIT
    """
    ...
    WHERE EXEC_TRN_ID IN ('4267-SITEST10')
  ...
  Scenario: Load Trades file for testing
    ...
    And I assign "010_new_trade_CIS.xml" to variable "INPUT_FILENAME3"
    ...
    """
      select count(*) TRANS_ROW_COUNT from ft_t_extr where trd_id ='4267-SITEST10' and end_tms is null
      """
    ...
    """
      ...
      WHERE TRD_ID = '4267-SITEST10' AND  END_TMS IS NULL
      )
      """
  ...
  This scenario is to load the trade file to load data to genrate 2nd revision settlement instruction report
    ...
    Given I assign "010_trdcomm_changed.xml" to variable "INPUT_FILENAME3"
    And I assign "/dmp/out/taiwan/settlement" to variable "PUBLISHING_DIR"
  ...
  This scenario is to load trade file to load data to generate 3rd revision settlement instruction report
    ...
    Given I assign "010_price_changed.xml" to variable "INPUT_FILENAME3"
    And I assign "/dmp/out/taiwan/settlement" to variable "PUBLISHING_DIR"
