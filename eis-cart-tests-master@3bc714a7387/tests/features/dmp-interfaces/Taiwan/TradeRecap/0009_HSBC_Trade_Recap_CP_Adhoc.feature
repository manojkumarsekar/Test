...
@dmp_taiwan @trade_recap_adhoc @trade_recap_cp_adhoc
@eisdev_4834

Feature: Test Publishing of HSBC Trade Recap CP data for Adhoc publishing for a Fund
  ...
  Scenario: Clear old test data and setup variables
    ...
    """
    ${testdata.path}/sql/Clear_EXTR_EXST_HSBC_CP_Adhoc.sql
    """

    And I assign "500" to variable "workflow.max.polling.time"

  Scenario: Clear any residual prod copy trades recaps by running the report once

    Given I assign "traderecap_hsbc_CP_REPO_adhoc" to variable "PUBLISHING_FILE_NAME"
    ...
    When I process publishing wrapper with below parameters and wait for the job to be completed
      ...
      | SUBSCRIPTION_NAME           | EITW_DMP_TO_HSBC_TRADEFLOW_CP_ADHOC_SUB |
      | EXTRACT_STREETREF_TO_SUBMIT | true                                    |
      | RUNTIME_CHAR_VAL_TXT        | Test4744                                |
  ...
  Scenario: Setup new account group and Financial Role Account Participant data in DMP linked to above account
    ...
    """
    ${testdata.path}/sql/SetUp_FRAP_HSBC_CP_REP_B1_TOM_4744.sql
    """

    And I execute below query to "setup prerequite data for Adhoc publishing"
    """
  ...
  Scenario: Load data for Security, Counterparty & Trades
    ...
    And I assign "tradefile_hsbc_CP_REPO_Adhoc.xml" to variable "INPUT_FILENAME3"
  ...
  Scenario: Publish trade recap file for HSBC
    ...
    And I expect value of column "EXST_ROW_COUNT" in the below SQL query equals to "1":
      ...
      WHERE TRD_ID in ('4744-4744-01') AND  END_TMS IS NULL
      )
      """

  Scenario: Verify trade recap HSBC file

    And I assign "TradeRecapExpected_hsbc_CP_REPO_Adhoc.csv" to variable "EXPECTED_FILE"
