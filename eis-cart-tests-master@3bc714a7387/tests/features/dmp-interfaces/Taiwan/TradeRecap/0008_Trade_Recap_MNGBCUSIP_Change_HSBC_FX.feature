...
@dmp_taiwan @tom_4815 @trade_recap  @tom_5364 @tom_5072 @eisdev_4567 @eisdev_6990 @eisdev_6990_hsbc_fx
Feature: This feature file is to test Trade Recap data published with MNGBCUSIP identifier.
  ...
  This feature file to test above scenarios with HSBC FX trade recap publishing
...
#Scenarios to test HSBC FX publishing


  Scenario: Loading BCUSIP and trade from MNG instance for HSBC FX

    Given I assign "tradefile_hsbc_MNG_FX_TOM_4815.xml" to variable "INPUT_FILENAME_TXN"
    And I assign "tradefile_hsbc_ES_FX_TOM_4815.xml" to variable "INPUT_FILENAME_TXN_ES"
    And I assign "sm_ES_FX_TOM_4815.xml" to variable "INPUT_FILENAME_SM_ES"
    And I assign "sm_MNG_FX_TOM_4815.xml" to variable "INPUT_FILENAME_SM"
  ...
  Scenario: Publish trade recap file for HSBC FX - MnG

    Given I assign "traderecap_hsbc_FX_MnG" to variable "PUBLISHING_FILE_NAME"
    And I assign "/dmp/out/hsbc" to variable "publishDirectory"
    And I generate value with date format "YYYYMMdd" and assign to variable "VAR_SYSDATE"
    ...
    And I expect value of column "EXST_ROW_COUNT" in the below SQL query equals to "1":
      ...
      WHERE TRD_ID in ('4815-4815_FX') AND  END_TMS IS NULL
      )
      """

  Scenario: Verify trade recap HSBC FX file - MnG

    Given I assign "TradeRecapExpected_hsbc_FX_MnG_tom_4815_B1_template.csv" to variable "EXPECTED_FILE_TEMPLATE"
    And I assign "TradeRecapExpected_hsbc_FX_MnG_tom_4815_B1.csv" to variable "EXPECTED_FILE"
  ...
  Scenario: Loading BCUSIP and trade from ES instance for HSBC FX
    ...
    #Delete EXST status for trade 4815-4815_FX
    And I execute below query
    """
  ...
  Scenario: Publish trade recap file for HSBC FX - ES

    Given I assign "traderecap_hsbc_FX_ES" to variable "PUBLISHING_FILE_NAME"
    And I assign "/dmp/out/hsbc" to variable "publishDirectory"
    And I generate value with date format "YYYYMMdd" and assign to variable "VAR_SYSDATE"
  ...
  Scenario: Verify trade recap HSBC FX file - ES
    Given I assign "TradeRecapExpected_hsbc_FX_ES_tom_4815_B1_template.csv" to variable "EXPECTED_FILE_TEMPLATE"
    And I assign "TradeRecapExpected_hsbc_FX_ES_tom_4815_B1.csv" to variable "EXPECTED_FILE"
    And I create input file "${EXPECTED_FILE}" using template "${EXPECTED_FILE_TEMPLATE}" from location "${testdata.path}/outfiles"
