...
#https://jira.pruconnect.net/browse/EISDEV-7404 - Expected files updated to fix recon failure
...
@dmp_taiwan @tom_4815 @trade_recap  @tom_5364 @tom_5072 @eisdev_4567 @eisdev_6990 @eisdev_6990_hsbc_cp @eisdev_7464
Feature: This feature file is to test Trade Recap data published with MNGBCUSIP identifier for  HSBC - CP.
  ...
  This feature file to test above scenarios with HSBC - CP trade recap publishing
  ...
  Scenario: Clear any residual prod copy trades recaps by running the report once for HSBC
    ...
    When I process publishing wrapper with below parameters and wait for the job to be completed
      ...
      | SUBSCRIPTION_NAME           | EITW_DMP_TO_HSBC_TRADEFLOW_CP_REP_B1_SUB |
...
#Scenarios to test HSBC CP-REPO publishing

  Scenario: Loading BCUSIP and trade from MNG instance for HSBC CP

    Given I assign "tradefile_hsbc_MNG_CP_REPO_TOM_4815.xml" to variable "INPUT_FILENAME_TXN"
    And I assign "tradefile_hsbc_ES_CP_REPO_TOM_4815.xml" to variable "INPUT_FILENAME_TXN_ES"
    And I assign "sm_ES_CP_TOM_4815.xml" to variable "INPUT_FILENAME_SM_ES"
    And I assign "sm_MNG_CP_TOM_4815.xml" to variable "INPUT_FILENAME_SM"
  ...
  Scenario: Publish trade recap file for HSBC CP - MnG

    Given I assign "traderecap_hsbc_CP_MnG" to variable "PUBLISHING_FILE_NAME"
    And I assign "/dmp/out/hsbc" to variable "publishDirectory"
    And I generate value with date format "YYYYMMdd" and assign to variable "VAR_SYSDATE"
    ...
    And I expect value of column "EXST_ROW_COUNT" in the below SQL query equals to "1":
      ...
      WHERE TRD_ID in ('4815-4815_REPO') AND  END_TMS IS NULL
      )
      """

  Scenario: Verify trade recap HSBC CP file - MnG

    Then I expect all records from file1 of type CSV exists in file2
      | File1 | ${testdata.path}/outfiles/runtime/${PUBLISHING_FILE_NAME}_${VAR_SYSDATE}_1.csv    |
      | File2 | ${testdata.path}/outfiles/testdata/TradeRecapExpected_hsbc_CP_MnG_tom_4815_B1.csv |

  #waiting intentionally
    And I pause for 20 seconds

  Scenario: Loading BCUSIP and trade from ES instance for HSBC CP
    ...
    #Delete EXST status for trade 4815-4815_CP
    And I execute below query
    """
  ...
  Scenario: Publish trade recap file for HSBC CP - ES

    Given I assign "traderecap_hsbc_CP_ES" to variable "PUBLISHING_FILE_NAME"
    And I assign "/dmp/out/hsbc" to variable "publishDirectory"
    And I generate value with date format "YYYYMMdd" and assign to variable "VAR_SYSDATE"
  ...
  Scenario: Verify trade recap HSBC CP file - ES

    Then I expect all records from file1 of type CSV exists in file2
      | File1 | ${testdata.path}/outfiles/runtime/${PUBLISHING_FILE_NAME}_${VAR_SYSDATE}_1.csv   |
      | File2 | ${testdata.path}/outfiles/testdata/TradeRecapExpected_hsbc_CP_ES_tom_4815_B1.csv |