...
@tom_4686 @tom_4686_format1 @tw_order_placement @tom_3700 @cis_op_regression @cis_op_functional
@eisdev_7439

Feature: CISOrderPlacement | Functional | F014_2 | Sanity Test Publish Document workflow
  ...
  Scenario: Load orders for portfolio.
    ...
    And I assign "014_esi_orders.20190514_0445_format1.xml" to variable "INPUT_FILENAME"
    ...
    Given I execute below query
    """
	${TESTDATA_PATH}order/sql/INSERT_Y_ESUNPLTF1_4686.sql
    """
