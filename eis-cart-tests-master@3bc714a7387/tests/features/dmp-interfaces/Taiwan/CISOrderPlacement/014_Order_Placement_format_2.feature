...
@tom_4686 @tom_4686_format2 @tw_order_placement @cis_op_regression @cis_op_functional
@eisdev_7439

Feature: CISOrderPlacement | Functional | F014_3 | Sanity Test Publish Document workflow
  ...
  Scenario: Load orders for portfolio.
    ...
    Given I execute below query
    """
	${TESTDATA_PATH}order/sql/INSERT_Y_ESUNPLTF_4686.sql
    """
