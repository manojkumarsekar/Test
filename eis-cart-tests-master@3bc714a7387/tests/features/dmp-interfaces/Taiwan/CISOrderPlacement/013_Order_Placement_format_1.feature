...
@tom_4612 @tom_4677 @tw_4612_format1 @tw_order_placement @tw_4677_format1 @dmp_gs_upgrade
@eisdev_7439

Feature: Sanity Test Publish Document workflow
  ...
  Scenario: Load orders for portfolio.
    ...
    Given I execute below query
    """
	${TESTDATA_PATH}order/sql/INSERT_Y_ESUNPLTF1_4612.sql
    """
