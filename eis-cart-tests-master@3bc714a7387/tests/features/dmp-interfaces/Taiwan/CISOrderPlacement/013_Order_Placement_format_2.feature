...
@tom_4612 @tom_4677 @tw_4612_format2 @tw_order_placement @tw_4677_format2 @cis_op_regression @cis_op_functional
@eisdev_7439

Feature: CISOrderPlacement | Functional | F013_3 | Sanity Test Publish Document workflow
  ...
  Scenario: Load orders for portfolio.
    ...
    Given I execute below query
    """
	${TESTDATA_PATH}order/sql/INSERT_Y_ESUNPLTF_4612.sql
    """
