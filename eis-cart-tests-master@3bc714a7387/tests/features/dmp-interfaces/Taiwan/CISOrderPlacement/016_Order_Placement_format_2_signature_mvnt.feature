#https://jira.intranet.asia/browse/TOM-4686

@dmp_regression_integrationtest
@tom_4686 @tw_order_placement @cis_op_regression @cis_op_functional
@eisdev_7439

Feature: CISOrderPlacement | Functional | F016 | CIS Order Placement Format 2 for signature movement code
  ...
  Scenario: Clear data and assign variables
    ...
    And I assign "014_esi_orders.20190514_0445_format2.xml" to variable "INPUT_FILENAME"
