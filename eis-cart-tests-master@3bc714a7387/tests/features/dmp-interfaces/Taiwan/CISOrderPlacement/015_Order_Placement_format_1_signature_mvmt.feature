...
@tom_4686 @tw_order_placement @tom_4140 @tom_4140 @tom_4902 @tom_4902_signature
@cis_op_regression @cis_op_functional @eisdev_7439
Feature: CISOrderPlacement | Functional | F015 | CIS Order Placement Format 1 for signature movement code
  ...
  Scenario: Loading PDF file in local and performing direct PDF comparison with expected PDF
    ...
    Given I assign "ORDER_PLACEMENT_FORMAT1_SIGNATURE_BASE.pdf" to variable "EXPECTED_FILE"
