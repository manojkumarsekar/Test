...
@tw_settlement_instruction_format @tw_settlement_instruction_format_CIS
@tom_4608 @eisdev_7439
...
Feature: Feature file for SI CIS Mutual Fund PDF verification
  ...
  6. Change currency in trade file
  7. Load revised trade file
  8. Perform verification of data updated
  9. Publish PDF document by calling AOI workflow
  10. Verify whether PDF got published or not
  ...
  Scenario: Assigning variables and executing clean up
    ...
    And I assign "transaction_currency.xml" to variable "INPUT_FILENAME5"
  ...
  Scenario: Load trade file with change in currency
