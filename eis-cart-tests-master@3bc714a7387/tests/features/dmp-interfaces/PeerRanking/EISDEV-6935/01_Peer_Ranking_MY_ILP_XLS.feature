...
@eisdev_6935_XLS @eisdev_6935 @peer_ranking_dwh @eisdev_7414
Feature: Load and Update MY ILP Morningstar XLS report and verify details

  This is to test if MY ILP MorningStar Peer Ranking XLS files are getting converted to CSV format and getting loaded in DWH
  ...
  Scenario: Assign Variables
    ...
    And I assign "Processed_202008_Malaysia_Peer_Ranking_Insurance_Fund_Load_Load_file.csv" to variable "OUTPUT_FILENAME_MYILP"
    And I assign "Processed_202008_Malaysia_Peer_Ranking_Insurance_Fund_Update_Load_file.csv" to variable "OUTPUT_FILENAME_UPDATE_MYILP"
  ...
  Scenario: Run Excel to CSV Peer Ranking workflow
    ...
    Given I copy files below from local folder "${testdata.path}/testdata" to the host "dmp.ssh.inbound" folder "${PEERRANK_DOWNLOAD_DIR}":
      | 202008 Malaysia Peer Ranking Insurance Fund Load.xls |
  ...
  Scenario: Run Excel to CSV Peer Ranking workflow for update file
    ...
    Given I copy files below from local folder "${testdata.path}/testdata" to the host "dmp.ssh.inbound" folder "${PEERRANK_DOWNLOAD_DIR}":
      | 202008 Malaysia Peer Ranking Insurance Fund Update.xls |
