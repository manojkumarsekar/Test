...
@eisdev_6852_XLSX @eisdev_6852 @peer_ranking_dwh @eisdev_7414
Feature: Load and Update TW Unit Trust Morningstar XLSX report and verify details

  This is to test if TW Unit Trust MorningStar Peer Ranking XLSX files are getting converted to CSV format and getting loaded in DWH
  ...
  Scenario: Assign Variables
    ...
    And I assign "Processed_Performance_Comparison_TW_Load_20200915_Local_PR-TW_20200915.csv" to variable "OUTPUT_FILENAME_LOCALPRTW"
    And I assign "Processed_Performance_Comparison_TW_Update_20200915_Local_PR-TW_20200915.csv" to variable "OUTPUT_FILENAME_UPDATE_LOCALPRTW"
  ...
  Scenario: Run Excel to CSV Peer Ranking workflow
    ...
    Given I copy files below from local folder "${testdata.path}/testdata" to the host "dmp.ssh.inbound" folder "${PEERRANK_DOWNLOAD_DIR}":
      | Performance Comparison_TW_Load_20200915.xlsx |
  ...
  Scenario: Perform checks in WAGR for checking load scenario
    ...
    """
      ...
      WHERE DATA_SRC_ID = 'MSTWUT' AND dw_Status_num =1 and ACCT_GRP_PURP_TYP='PRRNKGR' and ACCT_GRP_DESC ='Taiwan Fund Taiwan Small/Mid-Cap Value Equity'
    """
  ...
  Scenario: Perform checks in WAGP for checking load scenario
    ...
    """
      ...
      WHERE DATA_SRC_ID = 'MSTWUT' AND ACCT_PRT_PURP_TYP='PRRNKPCT' and dw_Status_num =1 and prnt_wagr_sok in (select wagr_sok from ft_T_wagr where dw_Status_num =1 and ACCT_GRP_PURP_TYP='PRRNKGR' and ACCT_GRP_DESC ='Taiwan Fund Taiwan Small/Mid-Cap Value Equity')
    """
  ...
  Scenario: Perform checks in WCRI for checking load scenario
    ...
    """
      ...
      WHERE DATA_SRC_ID = 'MSTWUT' AND DW_STATUS_NUM =1 and ACCT_SOK = (select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')
    """
  ...
  Scenario Outline: Verify the data uploaded in column <Column>
    ...
    Examples: Data Verifications having value not zero
      | Column                                   | Query                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
      | GroupInvestment                          | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS GroupInvestment  from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.USR_CHAR_VAL_TXT_2='Eastspring Taiwan M/S Cap Sel Value Eq Fd'        |
      | RegionofSale                             | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS RegionofSale from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.USR_CHAR_VAL_TXT_6='Taiwan'                                               |
      | FirmName                                 | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS FirmName from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.USR_CHAR_VAL_TXT_5='Eastspring Investments Limited'                           |
      | ReturnDate                               | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS ReturnDate from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and trunc(w.adjst_tms)=to_date('11-09-2020','DD-MM-YYYY')                         |
      | AsOfDate                                 | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS AsOfDate from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and trunc(w.as_of_tms)=to_date('31-08-2020','DD-MM-YYYY')                           |
      | ISIN                                     | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS ISIN from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.USR_CHAR_VAL_TXT_3='TW000T0705Y1'                                                 |
      | SECID                                    | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS SECID from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.USR_CHAR_VAL_TXT_7='F0HKG06Z53'                                                  |
      | Netshare                                 | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS Netshare from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.USR_VAL_CAMT_1='23.188269'                                                    |
      | MorningstarCategory                      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS MorningstarCategory from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.USR_CHAR_VAL_TXT_4='Taiwan Fund Taiwan Small/Mid-Cap Value Equity' |

      | ReturnCumulative1Month                   | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS ReturnCumulative1Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RETURN_1M_CAMT='11.90033'                                       |
      | PeerGroupRank1Month                      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupRank1Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_1M_PGRP_RNK_NUM='1'                                            |
      | PeerGroupQuartile1Month                  | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupQuartile1Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_1M_PGRP_QRTL_NUM='2'                                       |
      | Noofinvestmentsrankedinpeergroup1Month   | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS Noofinvestmentsrankedinpeergroup1Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_1M_PGRP_PART_NUM='3'                        |
      ...
      | PeerGroupRank3Month                      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupRank3Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_3M_PGRP_RNK_NUM='4'                                            |
      | PeerGroupQuartile3Month                  | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupQuartile3Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_3M_PGRP_QRTL_NUM='5'                                       |
      | Noofinvestmentsrankedinpeergroup3Month   | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS Noofinvestmentsrankedinpeergroup3Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_3M_PGRP_PART_NUM='6'                        |

      | ReturnCumulative6Month                   | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS ReturnCumulative6Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RETURN_6M_CAMT='-2.864989'                                      |
      | PeerGroupRank6Month                      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupRank6Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_6M_PGRP_RNK_NUM='7'                                            |
      | PeerGroupQuartile6Month                  | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupQuartile6Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_6M_PGRP_QRTL_NUM='8'                                       |
      | Noofinvestmentsrankedinpeergroup6Month   | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS Noofinvestmentsrankedinpeergroup6Month from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.RET_6M_PGRP_PART_NUM='9'                        |

      | ReturnCumulativeYTDMonth                 | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS ReturnCumulativeYTDMonth from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.YTD_RETURN_CAMT='-20.91465'                                   |
      | PeerGroupRankYTDMonth                    | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupRankYTDMonth from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.YTD_RET_PGRP_RNK_NUM='10'                                        |
      ...
      | NoofinvestmentsrankedinpeergroupYTDMonth | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS NoofinvestmentsrankedinpeergroupYTDMonth from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.YTD_RET_PGRP_PART_NUM='12'                    |

      | ReturnCumulative1Yr                      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS ReturnCumulative1Yr from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.CUM_1YR_RETURN_CAMT='-4.898863'                                    |
      | PeerGroupRank1Yr                         | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupRank1Yr from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.CUM_1Y_RET_PGRP_RNK_NUM='13'                                          |
      ...
      | Noofinvestmentsrankedinpeergroup1Yr      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS Noofinvestmentsrankedinpeergroup1Yr from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.CUM_1Y_RET_PGRP_PART_NUM='15'                      |
      ...
      | PeerGroupRank5Yr                         | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupRank5Yr from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.AN_5Y_RET_PGRP_RNK_NUM='19'                                           |
      ...
      | Noofinvestmentsrankedinpeergroup5Yr      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS Noofinvestmentsrankedinpeergroup5Yr from ft_w_wcri w where data_src_id = 'MSTWUT' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from FT_T_WAIR where iss_sok in (select iss_sok from ft_t_wisu where isin_id ='TW000T0705Y1' and dw_Status_num =1 and PREF_ID_CTXT_TYP='EISSECID') and dw_Status_num =1 and ACCT_ISSU_RL_TYP='AUT')) and dw_status_num =1 and w.AN_5Y_RET_PGRP_PART_NUM='21'                       |
  ...
  Scenario: Run Excel to CSV Peer Ranking workflow for update file
    ...
    Given I copy files below from local folder "${testdata.path}/testdata" to the host "dmp.ssh.inbound" folder "${PEERRANK_DOWNLOAD_DIR}":
      | Performance Comparison_TW_Update_20200915.xlsx |
    ...
    Then I expect below files to be present in the host "dmp.ssh.inbound" into folder "${PEERRANK_UPLOAD_DIR}" after processing:
      | ${OUTPUT_FILENAME_UPDATE_LOCALPRTW} |
