...
@eisdev_6963_XLSX @eisdev_6963 @peer_ranking_dwh @eisdev_7414
Feature: Load and Update KOR PER XLSX report and verify details

  This is to test if KOR PER Peer Ranking XLSX files are getting converted to CSV format and getting loaded in DWH
  ...
  Scenario: Run Excel to CSV Peer Ranking workflow for update file
    ...
    Given I copy files below from local folder "${testdata.path}/testdata" to the host "dmp.ssh.inbound" folder "${PEERRANK_DOWNLOAD_DIR}":
      | Update Fund performance as of 202008.xlsx |
