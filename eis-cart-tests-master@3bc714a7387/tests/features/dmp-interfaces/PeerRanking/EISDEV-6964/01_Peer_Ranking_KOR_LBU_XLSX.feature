...
@eisdev_6964_XLSX @eisdev_6964 @peer_ranking_dwh @eisdev_7414 @eisdev_7444
Feature: Load and Update KOR LBU XLSX report and verify details
  ...
  Scenario Outline: Verify the data uploaded in column <Column>
    ...
    Examples: Data Verifications having value not zero
      ...
      | PeerGroupPercentile1Month   | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupPercentile1Month from ft_w_wcri w where data_src_id = 'MSKORLBU' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from ft_t_wact where dw_status_num =1 and intrnl_id11= 'QSLU51346655')) and dw_status_num =1 and w.RET_1M_PGRP_PCTL_NUM='26'                                                                 |
      ...
      | PeerGroupPercentile3Month   | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupPercentile3Month from ft_w_wcri w where data_src_id = 'MSKORLBU' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from ft_t_wact where dw_status_num =1 and intrnl_id11= 'QSLU51346655')) and dw_status_num =1 and w.RET_3M_PGRP_PCTL_NUM='28'                                                                 |
      ...
      | PeerGroupPercentile6Month   | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupPercentile6Month from ft_w_wcri w where data_src_id = 'MSKORLBU' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from ft_t_wact where dw_status_num =1 and intrnl_id11= 'QSLU51346655')) and dw_status_num =1 and w.RET_6M_PGRP_PCTL_NUM='27'                                                                 |
      ...
      | PeerGroupPercentileYTDMonth | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupPercentileYTDMonth from ft_w_wcri w where data_src_id = 'MSKORLBU' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from ft_t_wact where dw_status_num =1 and intrnl_id11= 'QSLU51346655')) and dw_status_num =1 and w.YTD_RET_PGRP_QRTL_NUM='11'                                                              |
      ...
      | PeerGroupPercentile1Yr      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupPercentile1Yr from ft_w_wcri w where data_src_id = 'MSKORLBU' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from ft_t_wact where dw_status_num =1 and intrnl_id11= 'QSLU51346655')) and dw_status_num =1 and w.CUM_1Y_RET_PGRP_PCTL_NUM='10'                                                                |
      ...
      | PeerGroupPercentile3Yr      | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupPercentile3Yr from ft_w_wcri w where data_src_id = 'MSKORLBU' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from ft_t_wact where dw_status_num =1 and intrnl_id11= 'QSLU51346655')) and dw_status_num =1 and w.AN_3Y_RET_PGRP_PCTL_NUM='25'                                                                 |
      ...
      | PeerGroupPercentile1Week    | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupPercentile1Week from ft_w_wcri w where data_src_id = 'MSKORLBU' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from ft_t_wact where dw_status_num =1 and intrnl_id11= 'QSLU51346655')) and dw_status_num =1 and w.USR_VAL_CAMT_35='9'                                                                        |
  ...
  Scenario: Run Excel to CSV Peer Ranking workflow for update file
    ...
    Given I copy files below from local folder "${testdata.path}/testdata" to the host "dmp.ssh.inbound" folder "${PEERRANK_DOWNLOAD_DIR}":
      | Peer group ranking(E) Update _20200831.xlsx |
  ...
  Scenario Outline: Verify the data uploaded in column <Column>
    ...
    Examples: Data Verifications having value not zero
      ...
      | PeerGroupPercentileYTDMonth | select CASE WHEN COUNT(*) = 1 THEN 'PASS' ELSE 'FAIL' END AS PeerGroupPercentileYTDMonth from ft_w_wcri w where data_src_id = 'MSKORLBU' and return_typ ='NetNAVGrossMgtFees' and dw_Status_num =1 and acct_sok in ((select acct_sok from ft_t_wact where dw_status_num =1 and intrnl_id11= 'QSLU51346655')) and dw_status_num =1 and w.YTD_RET_PGRP_PCTL_NUM='20' |