...
@dmp_security_uploader @apply_lock_new @esidev_6192
Feature: 007 | Security Uploader | Record Lock | Apply Lock New ISCL
  Verify Lock is applied when APPLY_LOCK attribute is set to Y to new ISCL. Also verify data is not updated to lock defined on the record.
