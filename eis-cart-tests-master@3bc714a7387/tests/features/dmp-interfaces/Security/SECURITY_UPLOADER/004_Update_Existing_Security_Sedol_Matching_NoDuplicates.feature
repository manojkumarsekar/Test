...
@dmp_security_uploader @update_exiting_security_noduplicates @esidev_6192
Feature: 004 | Security Uploader | Update Existing Security | Same Sedol from BRS and EIS | No Duplicates
  Verify Sedol from the Security Uploader does not create duplicate ft_t_isid records for sedol
  ...
  Scenario: End date Instruments in GC and VD DB and Assign Variables
    ...
    And I assign "SBD5CMH28_BRS_F10_withsedol.xml" to variable "INPUT_FILENAME_BRS_F10"
  ...
  Scenario: Loading F10 for BCUSIP SBD5CMH28 and SEDOL BD5CMH2
  ...
  Verify Duplicate Listing is not created
