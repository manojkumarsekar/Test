...
@dmp_security_uploader @vsh_eis_brs @esidev_6192
Feature: 008 | Security Uploader | VSH | EIS with BRS
  Verify data set up from EIS is updated via BRS as VSH is Rank 1 for both data sources
