...
@tom_3620 @esi_orders_life_cycle @esi_orders_lifecycle_2_2_intraday @tom_4090
Feature: 002 | Orders | Capture Order Life Cycle Intraday Day 2 Run 6
  ...
  Expected Output :  OrderId A1230046,A1230146 to be sent to STARCOM
  ...
  #Assign Variables
    ...
    And I assign "002_esi_order_Order_Life_Cycle_Intraday2_2.xml" to variable "INPUT_FILENAME"
    And I assign "002_ESI_Orders_Order_Life_Cycle_2_2_Intraday" to variable "PUBLISHING_FILE_NAME"
    And I assign "002_ESI_Orders_Order_Life_Cycle_Intraday_2_2_Master_Template.csv" to variable "MASTER_TEMPLATE"
    And I assign "002_ESI_Orders_Order_Life_Cycle_Intraday_2_2_Master.csv" to variable "MASTER_FILE"
