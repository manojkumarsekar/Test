...
@tom_3620 @esi_orders_life_cycle @esi_orders_lifecycle_2_3_eod @tom_4090 @tom_3795
Feature: 002 | Orders | Capture Order Life Cycle EOD Day 2 Run 7
  ...
  Expected Output :
  OrderId A1278682 should be sent to STARCOM
  Exclude Intraday BOOKED and CANCELLED orders A1230046, A1230146, A1404713, A1404813, A1402744, A1402644
  ...
  #Assign Variables
    ...
    And I assign "002_esi_order_Order_Life_Cycle_EOD2.xml" to variable "INPUT_FILENAME"
    And I assign "002_ESI_Orders_Order_Life_Cycle_2_3_EOD" to variable "PUBLISHING_FILE_NAME"
    And I assign "002_EOD2_Template_1.csv" to variable "EOD2_TEMPLATE_1"
    And I assign "002_EOD2_Template_2.csv" to variable "EOD2_TEMPLATE_2"
    And I assign "002_EOD2_1.csv" to variable "EOD2_1"
    And I assign "002_EOD2_2.csv" to variable "EOD2_2"
  ...
  #Extract Data
    ...
    #Reconcile Data
    And I create input file "${EOD2_1}" using template "${EOD2_TEMPLATE_1}" with below codes from location "${TESTDATA_PATH}/outfiles"
      | CURR_DATE | DateTimeFormat:YYYY-MM-dd |

    And I create input file "${EOD2_2}" using template "${EOD2_TEMPLATE_2}" with below codes from location "${TESTDATA_PATH}/outfiles"
      | CURR_DATE | DateTimeFormat:YYYY-MM-dd |

    Then I expect all records from file1 of type CSV exists in file2
      | File1 | ${TESTDATA_PATH}/outfiles/testdata/${EOD2_1}                                   |
    ...
    Then I expect none of the records from file1 of type CSV exists in file2
      | File1 | ${TESTDATA_PATH}/outfiles/testdata/${EOD2_2}                                   |
      | File2 | ${TESTDATA_PATH}/outfiles/runtime/${PUBLISHING_FILE_NAME}_${VAR_SYSDATE}_1.csv |
