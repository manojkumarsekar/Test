...
@tom_3620 @esi_orders_life_cycle @esi_orders_lifecycle_1_3_intraday @tom_4090 @tom_3795
Feature: 002 | Orders | Capture Order Life Cycle Intraday Day 1 Run 3
  ...
  Expected Output : OrderId A1230046, A1404713, A1404813 should be sent to STARCOM
  ...
  #Assign Variables
    ...
    And I assign "002_esi_order_Order_Life_Cycle_Intraday1_3.xml" to variable "INPUT_FILENAME"
    And I assign "002_ESI_Orders_Order_Life_Cycle_1_3_Intraday" to variable "PUBLISHING_FILE_NAME"
    And I assign "002_ESI_Orders_Order_Life_Cycle_Intraday_1_3_Master_Template.csv" to variable "MASTER_TEMPLATE"
    And I assign "002_ESI_Orders_Order_Life_Cycle_Intraday_1_3_Master.csv" to variable "MASTER_FILE"
