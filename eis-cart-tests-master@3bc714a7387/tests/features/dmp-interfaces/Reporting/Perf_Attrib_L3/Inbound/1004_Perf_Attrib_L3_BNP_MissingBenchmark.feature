...
@dmp_dw_regression
@tom_4971 @tom_4971_missingbnch @tom_5191 @perf_attrib_l3 @eisdev_5525 @eisdev_6591
Feature: Test BNP performance L3 file for missing benchmark
  ...
  Scenario: TC_3: Verify if the exception is thrown
    ...
    Then I expect 1 exceptions are captured with the following criteria
      | PARM_VAL_TXT            | BL3PRIM IRPID ALAIEFTST EIS WACKGSWAccountAccountRole                                               |
      | NOTFCN_ID               | 60008                                                                                               |
