...
@eisdev_6905
@valid_portfolio
@valid_portfolio_portfolio
Feature: Exception Management | 153 | PORTFOLIO | valid portfolio
  Loading PORTFOLIO with valid portfolio and expecting record should be filtered
  ...
  Scenario: Initialize variables used across the feature file
    ...
    And I assign "011_153_valid_portfolios_PORTFOLIO.xml" to variable "INPUT_FILENAME"
