...
@valid_portfolio
@valid_portfolio_txn
Feature: Exception Management | 153 | TRANSACTION | valid portfolio
  Loading TRANSACTION with valid portfolio and expecting record should be filtered
  ...
  Scenario: Initialize variables used across the feature file
    ...
    And I assign "005_153_valid_portfolios_TRANSACTION.xml" to variable "INPUT_FILENAME"
