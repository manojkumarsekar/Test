...
@valid_portfolio
@valid_portfolio_grp
Feature: Exception Management | 153 | PORTFOLIO GROUP | valid portfolio
  Loading PORTFOLIO GROUP with valid portfolio and expecting record should be filtered
  ...
  Scenario: Initialize variables used across the feature file
    ...
    And I assign "007_153_valid_portfolios_PORTFOLIO_GRP.xml" to variable "INPUT_FILENAME"
