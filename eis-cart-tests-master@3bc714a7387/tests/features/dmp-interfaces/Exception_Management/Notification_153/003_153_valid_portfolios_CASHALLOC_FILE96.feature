...
@eisdev_6905
@valid_portfolio
@valid_portfolio_CASHALLOC_FILE96
Feature: Exception Management | 153 | CASHALLOC_FILE96 | valid portfolio
  Loading Cash Alloc File 96 with valid portfolio and expecting record should be filtered
  ...
  Scenario: Initialize variables used across the feature file
    ...
    And I assign "003_153_valid_portfolios_CASHALLOC_FILE96.xml" to variable "INPUT_FILENAME"
