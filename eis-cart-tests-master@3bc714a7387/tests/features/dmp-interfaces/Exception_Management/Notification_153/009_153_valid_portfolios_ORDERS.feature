...
@eisdev_6905
@valid_portfolio
@valid_portfolio_order
Feature: Exception Management | 153 | ORDERS | valid portfolio
  Loading ORDERS with valid portfolio and expecting record should be filtered
  ...
  Scenario: Initialize variables used across the feature file
    ...
    And I assign "009_153_valid_portfolios_ORDERS.xml" to variable "INPUT_FILENAME"
