...
Feature: Exception Management | 60001 | SCB Broker Price | blank CLIENT_ID
  Loading SCB Broker Price with blank CLIENT_ID and expecting record to get filtered
  ...
  Scenario: Initialize variables used across the feature file
    ...
    And I assign "004_60001_SCB_BROKER_PRICE.xml" to variable "INPUT_FILENAME"

  Scenario: Load SCB Broker Price file
