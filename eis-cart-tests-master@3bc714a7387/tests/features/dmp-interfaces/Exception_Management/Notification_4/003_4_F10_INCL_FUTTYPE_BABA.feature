...
@F10
@F10_missing_INCL
Feature: Exception Management | 4 | F10 | INCL with FUTTYPE-BABA classification set
  Loading F10 with FUTTYPE-BABA classification set and expecting no exceptions
  ...
  Scenario: Initialize variables used across the feature file
    ...
    And I assign "003_4_F10_INCL_FUTTYPE_BABA.xml" to variable "INPUT_FILENAME"
