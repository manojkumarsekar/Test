@web @gs_ui_smoke @gs_ui_menu_verification @gs_ui_verify_user_role_menu
Feature: GS Portal Smoke Test - Verify User Role Menu
  ...
  Scenario: Launch GS UI
    Given I login to golden source UI with "users" role
  ...
  Scenario: Close browsers and Login again
    ...
    And I login to golden source UI with "users" role
