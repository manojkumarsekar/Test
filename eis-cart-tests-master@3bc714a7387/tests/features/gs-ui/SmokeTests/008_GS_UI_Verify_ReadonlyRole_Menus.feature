@web @gs_ui_smoke @gs_ui_menu_verification @gs_ui_verify_readonly_menu
Feature: GS Portal Smoke Test - Verify ReadOnly Role Menu
  ...
  Scenario: Launch GS UI
    Given I login to golden source UI with "readonly" role
  ...
  Scenario: Close browsers and Login again
    ...
    And I login to golden source UI with "readonly" role
