@web @gs_ui_smoke @gs_ui_menu_verification @gs_ui_verify_task_supervisor_menu
Feature: GS Portal Smoke Test - Verify Task Supervisor Role Menu
  ...
  Scenario: Launch GS UI
    Given I login to golden source UI with "task_supervisor" role
  ...
  Scenario: Close browsers and Login again
    ...
    And I login to golden source UI with "task_supervisor" role
