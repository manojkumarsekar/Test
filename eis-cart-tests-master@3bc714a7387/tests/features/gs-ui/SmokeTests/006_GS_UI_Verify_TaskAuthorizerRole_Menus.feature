@web @gs_ui_smoke @gs_ui_menu_verification @gs_ui_verify_task_auth_menu
Feature: GS Portal Smoke Test - Verify Task Authorizer Role Menu
  ...
  Scenario: Launch GS UI
    Given I login to golden source UI with "task_authorizer" role
