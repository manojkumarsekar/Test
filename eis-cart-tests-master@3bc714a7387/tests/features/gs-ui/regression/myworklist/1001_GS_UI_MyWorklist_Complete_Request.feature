@web @gs_ui_regression @my_worklist_complete
@gc_ui_benchmark @gc_ui_worklist
Feature: My Worklist testing for Complete Request
  ...
  Scenario: Complete request
    ...
    When I create a benchmark with following details
      | ESI Benchmark Name        | GAA1_SGP225_${VAR_RANDOM} |
    ...
    And I approve a record from My WorkList with entity name "GAA1_SGP225_${VAR_RANDOM}"

    When I relogin to golden source UI with "task_assignee" role
    Then I expect a record in My WorkList with entity name "GAA1_SGP225_${VAR_RANDOM}" and status "Completed"
