...
@web @gs_ui_regression @gs_ui_normal_lock_fields @eisdev_6313 @eisdev_6365 @eisdev_6820
@gc_ui_lock @gc_ui_worklist @eisdev_7458

Feature: Apply Normal Lock on fields and unlock
  This feature file can be used to check the below scenarios
  1. Applying of normal lock to a field
  2. Manual removal of lock

  Scenario: TC1: Apply normal lock to a field for a portfolio
  ...
  Scenario: TC2: Apply normal lock to a field for a portfolio
