...
@tom_3561 @esi_netflows @esi_netflows_exclude_from_uklife
Feature: Netflows Inbound and Outbound: Since "ATPTWM" fund is NOT part of SGLUKLNP group in ACGP, Verify that INTERO is NOT translated to SGOUFL; and INTERI is NOT translated to SGINFL
# =====================================================================
...
# Exclude "ATPTWM" and "NDCRMF" funds from SGLUKLNP group in ACGP 
# Publish Netflows Report
# Verify that INTERO is NOT translated to SGOUFL; and INTERI is NOT translated to SGINFL
# =====================================================================
...
# Step 9: Reconcile Data. Since "ATPTWM" fund is NOT part of SGLUKLNP group in ACGP, Verify that INTERO is NOT translated to SGOUFL; and INTERI is NOT translated to SGINFL
