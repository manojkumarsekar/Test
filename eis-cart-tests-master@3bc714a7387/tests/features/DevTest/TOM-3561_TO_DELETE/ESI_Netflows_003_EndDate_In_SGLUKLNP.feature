...
@tom_3561 @esi_netflows @esi_netflows_enddate_in_uklife
Feature: Netflows Inbound and Outbound: Since "ATPTWM" fund is end-dated in SGLUKLNP group in ACGP, Verify that INTERO is NOT translated to SGOUFL; and INTERI is NOT translated to SGINFL
# =====================================================================
...
# End-Date "ATPTWM" fund in SGLUKLNP group in ACGP 
# Publish Netflows Report
# Verify that INTERO is NOT translated to SGOUFL; and INTERI is NOT translated to SGINFL for "ATPTWM"
# =====================================================================
...
# Step 9: Reconcile Data. Since "ATPTWM" fund is end-dated in SGLUKLNP group in ACGP, Verify that INTERO is NOT translated to SGOUFL; and INTERI is NOT translated to SGINFL for the UK-Life fund "ATPTWM"
