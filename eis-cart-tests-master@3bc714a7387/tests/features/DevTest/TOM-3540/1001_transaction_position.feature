...
#@tom_3540 @month_end_reporting @data_dumps @dmp_regression_unittest @dwh_interfaces @tom_4314

#No regression tag observed. Hence, modular tag (Ex: gc_interface or dw_interface) has not given.
@tom_3540 @month_end_reporting @tom_4314
Feature: Month-end data dumps with missing client details
  ...
  Scenario: Cleardown any existing data
    ...
    And I assign "tests/test-data/DevTest/TOM-3540" to variable "testdata.path"
    ...
    And I assign "ESIPME_TRN_20120731.out" to variable "TRN_INPUT_FILENAME"
    And I assign "ESIPME_POS_20120731.out" to variable "POS_INPUT_FILENAME"
    And I assign "TOM-3540_trn_output" to variable "TRN_PUBLISHING_FILENAME"
    And I assign "TOM-3540_pos_output" to variable "POS_PUBLISHING_FILENAME"
    And I assign "/dmp/out/eis/general" to variable "PUBLISHING_DIR"
    And I set the database connection to configuration "dmp.db.DW"

    # Clear data from warehouse tables
  ...
  Scenario: Load daily exchange rates
    ...
    Then I expect value of column "EXR_COUNT" in the below SQL query equals to "110":
        """
  ...
  # Validation: records in ft_t_wfxr
    Then I expect value of column "EXR_COUNT" in the below SQL query equals to "5":
        """
  ...
  Scenario: Load portfolios
    ...
    Then I expect value of column "PFL_COUNT" in the below SQL query equals to "3":
        """
  ...
  Scenario: Load securities
    ...
    Then I expect value of column "SEC_COUNT" in the below SQL query equals to "3":
        """
  ...
  Scenario: Load Positions
    ...
    Then I expect value of column "POS_COUNT" in the below SQL query equals to "2":
        """
  ...
  Scenario: Load Transactions
    ...
    # Validation: records in ft_t_wtrd
    Then I expect value of column "TRN_COUNT" in the below SQL query equals to "2":
        """
  ...
  Scenario: Check the reports record count and transactions' client details
    ...
    Then I expect file "${testdata.path}/outfiles/runtime/${TRN_PUBLISHING_FILENAME}.csv" should have 3 records
    And I expect column '"CLIENT_PORTFOLIO_GROUPING_NAME"' value to be "" where column '"ACCT_ID"' value is "ALTHEF" in CSV file "${testdata.path}/outfiles/runtime/${TRN_PUBLISHING_FILENAME}.csv"
    And I expect column '"CLIENT_PORTFOLIO_GROUPING_NAME"' value to be "PAC HK" where column '"ACCT_ID"' value is "AHPHMF" in CSV file "${testdata.path}/outfiles/runtime/${TRN_PUBLISHING_FILENAME}.csv"
  ...
  Scenario: Check the reports record count and positions' client details
    ...
    Then I expect file "${testdata.path}/outfiles/runtime/${POS_PUBLISHING_FILENAME}.csv" should have 3 records
    And I expect column '"CLIENT_PORTFOLIO_GROUPING_NAME"' value to be "" where column '"ACCT_ID"' value is "ALTHEF" in CSV file "${testdata.path}/outfiles/runtime/${POS_PUBLISHING_FILENAME}.csv"
    And I expect column '"CLIENT_PORTFOLIO_GROUPING_NAME"' value to be "IOF" where column '"ACCT_ID"' value is "ALGLVE" in CSV file "${testdata.path}/outfiles/runtime/${POS_PUBLISHING_FILENAME}.csv"
