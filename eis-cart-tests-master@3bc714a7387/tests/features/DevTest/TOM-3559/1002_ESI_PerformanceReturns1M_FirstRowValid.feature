...
@tom_3559 @performance_returns_1m @performance_returns_1m_first_row_valid
Feature: BNP Performance Returns (1M), with first row valid. Column Header and Data should be published.

  Perform in-memory translation of BNP Performance Returns file and publish to BRS
  The first record in the input file is a valid record, hence is published.
  ...
  Scenario: Clear the data as a Prerequisite
    ...
    Given I assign "ESI_FE_PerformanceReturns1M_FirstRowValid_20181001.csv" to variable "INPUT_FILENAME"
