...
# 22/11/2018      TOM-3887    Second Version
# =====================================================================
...
@tom_3559 @tom_4398 @performance_returns_1m @performance_returns_1m_first_row_invalid
Feature: BNP Performance Returns (1M), with first row invalid and skipped. Column Header and Data should be published.

  Perform in-memory translation of BNP Performance Returns file and publish to BRS
  The first record in the input file is an in-valid (but no exception) record and hence is skipped
  ...
  |0        |PRU_FM_FI_PIF-HIG| ABOR       |NAV          |Gross of all fees / wthdg taxes|31/5/2018|-0.015542742                 |First Record is invalid    |Skipped                 |
  ...
  Scenario: Clear the data as a Prerequisite
    ...
    Given I assign "ESI_FE_PerformanceReturns1M_FirstRowInvalid_20181001.csv" to variable "INPUT_FILENAME"
