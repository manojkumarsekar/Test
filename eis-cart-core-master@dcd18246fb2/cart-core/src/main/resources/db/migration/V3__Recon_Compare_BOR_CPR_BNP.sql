...
/****** Object:  StoredProcedure [dbo].[Compare_BOR_CPR_BNP]    Script Date: 29/11/2017 11:03:53 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        SELECT
            ...
            CASE WHEN RIGHT(LTRIM(RTRIM([Accounting Code])), 2) = ''_A'' THEN LEFT(LTRIM(RTRIM([Accounting Code])), LEN(LTRIM(RTRIM([Accounting Code]))) - 2) ELSE [Accounting Code] END AS [Entity Id],
            [Value Date],
            ''Net'' AS [Return Type],
            ...
            [1Y Fund Pri. Benchmark Return] AS [Internal BM 1Y],
