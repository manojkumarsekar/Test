...
public class FileDirUtil {
    ...
    public byte[] readFileToByteArray(final String filename) {
        try {
            ...
            LOGGER.error(READ_FILE_TO_STRING_FAILED_TO_READ_FILE_TO_STRING, filename, e);
    ...
    public String readFileToString(String filename) {
        try {
            return FileUtils.readFileToString(new File(filename), EncodingConstants.UTF_8);
        } catch (IOException e) {
            LOGGER.error(READ_FILE_TO_STRING_FAILED_TO_READ_FILE_TO_STRING, filename, e);
            throw new CartException(CartExceptionType.PROCESSING_FAILED, READ_FILE_TO_STRING_FAILED_TO_READ_FILE_TO_STRING, filename);
        }
    ...
    public String convertFileEncoding(final String filename, final String srcEncoding, final String targetEncoding) {
        try {
            ...
            LOGGER.error("Unable to convert File Encoding from [{}] to [{}]", srcEncoding, targetEncoding, e);
    ...
    public void writeStringToFile(String filename, String stringToWrite, boolean append) {
        try {
            FileUtils.writeStringToFile(new File(filename), stringToWrite, EncodingConstants.UTF_8, append);
        } catch (IOException e) {
            LOGGER.error(WRITE_STRING_TO_FILE_FAILED_TO_WRITE_TO_FILE, filename, e);
    ...
    public void forceMkdir(String dir) {
        try {
            ...
            LOGGER.error(FORCE_MKDIR_FAILED_TO_CREATE_FOLDER, dir, e);
    ...
    public void moveFileToDirectory(String srcFullpath, String destFullpath, boolean createDestDir) {
        try {
            ...
            LOGGER.error(FAILED_TO_MOVE_FILE_FROM_TO, srcFullpath, destFullpath, e);
    ...
    public void copyFile(File src, File dst) {
        try {
            ...
            LOGGER.error(FAILED_TO_COPY_FILE_FROM_TO, src, dst, e);
    ...
    public void move(String src, String dst) {
        try {
            ...
            LOGGER.error(FAILED_TO_MOVE_RENAME_FILE_FROM_TO, src, dst);
    ...
    public boolean fileDirExist(String pathName) {
        if (pathName == null) {
            LOGGER.error(PATH_NAME_MUST_BE_SPECIFIED);
    ...
    public String ensureTestOutDirExist(String testOutDir) {
        ...
        try {
            ...
            LOGGER.error(FAILED_TO_MAKE_DIR_WITH_FORCE, testOutDirFullpath);
    ...
    public String ensureDirExist(String dir) {
        try {
            ...
            LOGGER.error(FAILED_TO_MAKE_DIR_WITH_FORCE, dir);
    ...
    public String normalizePathToUnix(String rawClassFullpath) {
        if (Strings.isNullOrEmpty(rawClassFullpath)) {
            LOGGER.error("rawClassFullpath must not be empty or null");
    ...
    public String getFilenameFromPath(String path) {
        if (path == null) {
            LOGGER.error("getFilenameFromPath(): path must not be null");
    ...
    public String getDirnameFromPath(String path) {
        if (path == null) {
            LOGGER.error("getDirnameFromPath(): path must not be null");
    ...
    public boolean contentEquals(String file1, String file2) {
        try {
            ...
            LOGGER.error("IO error while comparing the contents of [{}] and [{}]", file1, file2);
    ...
    public void copyInputStreamToFile(InputStream ais, File outFile) {
        try {
            ...
            LOGGER.error("IO error while copying input stream to file [{}]", outFile, e);
    ...
    public long getRowsCountInFile(String filename) {
        try {
            ...
            LOGGER.error("getRowsCountInFile(): failed to get Rows Count from File [{}]", filename, e);
    ...
    public String readFileLineToString(String filename, int lineNumber) {
        try {
            ...
            LOGGER.error("readFileLineToString(): failed to read file line to String [{}]", filename);
    ...
    public Integer getFileLineNumberMatchingText(String filePath, String regExPattern) {
        if (Strings.isNullOrEmpty(regExPattern)) {
            LOGGER.error("RegExPattern Cannot be Null or Empty");
        ...
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader(filePath))) {
            ...
            LOGGER.error("IO Error while processing file [{}]", filePath, e);
    ...
    public void openFolderInFileExplorer(final String folderPath) {
        if (System.getProperty("os.name").toLowerCase().startsWith("windows")) {
            try {
                ...
                LOGGER.error("IO Error while opening folder [{}]", folderPath, e);
    ...
    public String copyLatestFileWithPattern(String srcPath, String filePattern, String dstPath) {
        try {
            ...
            LOGGER.error(FAILED_TO_COPY_FILE_FROM_TO, srcPath, dstPath, e);
